          ...
          steps: [
            {
              ...
              figure: {
                ...
                height: 200,
                items: [
                  { t: 'poly', pts: [[0.3, 1], [1.8, 1], [1.8, 3], [0.3, 3]], color: 'muted', label: '0' },
                  { t: 'poly', pts: [[2.2, 1], [3.7, 1], [3.7, 3], [2.2, 3]], color: 'a', label: '1' },
                  { t: 'poly', pts: [[4.1, 1], [5.6, 1], [5.6, 3], [4.1, 3]], color: 'a', label: '3' },
                  { t: 'poly', pts: [[6.0, 1], [7.5, 1], [7.5, 3], [6.0, 3]], color: 'a', label: '6' },
                  { t: 'poly', pts: [[7.9, 1], [9.4, 1], [9.4, 3], [7.9, 3]], color: 'a', label: '10' },
                  { t: 'poly', pts: [[9.8, 1], [11.3, 1], [11.3, 3], [9.8, 3]], color: 'result', label: '15' },
                  { t: 'vec', from: [1.8, 2], to: [2.2, 2], color: 'muted' },
                  { t: 'vec', from: [3.7, 2], to: [4.1, 2], color: 'muted' },
                  { t: 'vec', from: [5.6, 2], to: [6.0, 2], color: 'muted' },
                  { t: 'vec', from: [7.5, 2], to: [7.9, 2], color: 'muted' },
                  { t: 'vec', from: [9.4, 2], to: [9.8, 2], color: 'muted' },
                ],
                caption: {
                  en: 'total starts at 0 and picks up each i along the way — 0, 1, 3, 6, 10, 15 — the accumulator pattern, one step at a time.',
                  id: 'total dimulai dari 0 dan mengambil tiap i sepanjang jalan — 0, 1, 3, 6, 10, 15 — pola akumulator, selangkah demi selangkah.',
                },
              },
              code: 'total = 0\nfor i in range(1, 6):\n    total = total + i\nprint(total)',
              output: '15',
