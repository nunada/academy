  ...
  submodules: [
    /* --------------------------------------------------- 1.1 values & operators */
    {
          ...
          steps: [
            ...
            },
            {
              ...
              options: [
                ...
                { en: 'kota becomes "Malang"', id: 'kota menjadi "Malang"' },
                { en: 'kota stays "Surabaya", silently', id: 'kota tetap "Surabaya", tanpa pesan' },
            ...
            },
            {
              ...
              js: true,
              prompt: {
                en: 'Create `nama` holding `"Budi"` and `umur` holding `20`, then log them on two separate lines.',
        ...
        },
        {
          ...
          steps: [
            ...
            },
            {
              ...
              js: true,
              prompt: {
                en: 'A shirt costs 120000 and there is a 25 percent discount. Compute `hemat` and `bayar`, then log exactly `Hemat 30000, bayar 90000`.',
              ...
              hints: [
                { en: 'A quarter of the price is harga * diskon / 100.', id: 'Seperempat harganya adalah harga * diskon / 100.' },
                { en: 'What you pay is the price minus what you saved.', id: 'Yang dibayar adalah harga dikurangi yang dihemat.' },
                { en: 'console.log(`Hemat ${hemat}, bayar ${bayar}`);', id: 'console.log(`Hemat ${hemat}, bayar ${bayar}`);' },
              ],
              solution:
      ...
      project: {
        ...
        requirements: [
          { en: 'Start from `harga = 250000`, `jumlah = 3`, `diskonPersen = 10`, `pajakPersen = 11`.', id: 'Mulai dari `harga = 250000`, `jumlah = 3`, `diskonPersen = 10`, `pajakPersen = 11`.' },
          { en: '`subtotal` is price times quantity.', id: '`subtotal` adalah harga kali jumlah.' },
          { en: '`diskon` is the discount on the subtotal; `setelahDiskon` is what is left.', id: '`diskon` adalah potongan atas subtotal; `setelahDiskon` adalah sisanya.' },
          { en: '`pajak` is the tax on `setelahDiskon`; `total` is the two added.', id: '`pajak` adalah pajak atas `setelahDiskon`; `total` adalah keduanya dijumlahkan.' },
          { en: 'Log exactly four lines: `Subtotal: 750000`, `Diskon: 75000`, `Pajak: 74250`, `Total: 749250`.', id: 'Tampilkan tepat empat baris: `Subtotal: 750000`, `Diskon: 75000`, `Pajak: 74250`, `Total: 749250`.' },
        ],
        starter:
        ...
        hints: [
          ...
          { en: 'A percentage of x is `x * persen / 100`.', id: 'Persentase dari x adalah `x * persen / 100`.' },
    ...
    /* ------------------------------------------------- 1.2 branching & looping */
    {
          ...
          steps: [
            {
              ...
              body: {
                en: 'The shape is `if (kondisi) { ... } else { ... }`. Unlike Python there is no colon and indentation is only for humans — the braces are what group the block.',
            ...
            },
            {
              ...
              body: {
                en: 'An `if` accepts any value, not just a boolean. Six count as false — `false`, `0`, `""`, `null`, `undefined`, `NaN` — and everything else counts as true. That makes `if (nama)` a neat way to ask "is this filled in", but it also means `0` is treated as empty.',
            ...
            },
            {
              ...
              options: [
                { en: 'habis — 0 is falsy', id: 'habis — 0 termasuk falsy' },
                { en: 'tersedia — 0 is a real number', id: 'tersedia — 0 tetap angka sungguhan' },
                { en: 'Nothing', id: 'Tidak ada' },
                { en: 'An error', id: 'Error' },
              ],
              answer: 0,
              explain: {
                en: 'This is exactly the trap: writing `if (stok > 0)` says what you mean, and would behave the same here but not for -1.',
            ...
            },
            {
              ...
              template: 'if (nilai >= 70 ___ hadir >= 80) {\n  console.log("Lulus");\n}',
              blanks: ['&&'],
              explain: {
            ...
            },
            {
              ...
              js: true,
              prompt: {
                en: 'Read `jam` and log `Pagi` when it is 5–10, `Siang` when 11–14, `Sore` when 15–18, and `Malam` otherwise.',
                id: 'Baca `jam` lalu tampilkan `Pagi` bila 5–10, `Siang` bila 11–14, `Sore` bila 15–18, dan `Malam` selain itu.',
              },
              starter: 'const jam = 13;\n',
              tests: [
                {
              ...
              hints: [
                ...
                { en: 'A band needs two bounds: jam >= 5 && jam <= 10.', id: 'Sebuah rentang butuh dua batas: jam >= 5 && jam <= 10.' },
                { en: 'Malam is the final else — it needs no condition.', id: 'Malam adalah else terakhir — tidak butuh kondisi.' },
              ],
              solution:
        ...
        },
        {
          ...
          steps: [
            ...
            },
            {
              ...
              code: 'const kota = ["Surabaya", "Malang"];\n\nfor (const k of kota) {\n  console.log(k);\n}',
              output: 'Surabaya\nMalang',
            },
            {
              kind: 'quiz',
      ...
      project: {
        ...
        requirements: [
          { en: 'Start from `const nilai = [92, 78, 65, 45, 88];`.', id: 'Mulai dari `const nilai = [92, 78, 65, 45, 88];`.' },
          ...
          { en: 'Then log `Rata-rata: 73.6`.', id: 'Lalu tampilkan `Rata-rata: 73.6`.' },
          { en: 'Then log `Lulus: 3 dari 5` — a score of 70 or more passes.', id: 'Lalu tampilkan `Lulus: 3 dari 5` — nilai 70 ke atas dinyatakan lulus.' },
        ],
        starter: 'const nilai = [92, 78, 65, 45, 88];\n',
        tests: [
          {
