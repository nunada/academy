      ...
      lessons: [
        {
          ...
          steps: [
            ...
            },
            {
              ...
              explain: {
                en: 'A = integral from -2 to 2 of (8-2x^2) dx = [8x - 2x^3/3] from -2 to 2 = 2(16 - 16/3) = 64/3 ≈ 21.33.',
                id: 'A = integral dari -2 sampai 2 dari (8-2x^2) dx = [8x - 2x^3/3] dari -2 sampai 2 = 2(16 - 16/3) = 64/3 ≈ 21.33.',
              },
            },
          ],
        },
    ...
    /* ---------------------------------------------------- 6.2 volumes of revolution */
    {
      ...
      lessons: [
        {
          ...
          steps: [
            ...
            },
            {
              ...
              blanks: [{ answer: 23.56 }],
              hints: [
                { en: 'V = pi × integral from 1 to 4 of x dx.', id: 'V = pi × integral dari 1 sampai 4 dari x dx.' },
              ],
              explain: {
                en: 'V = pi[x^2/2] from 1 to 4 = pi(8 - 0.5) = 7.5pi ≈ 23.56.',
                id: 'V = pi[x^2/2] dari 1 sampai 4 = pi(8 - 0.5) = 7.5pi ≈ 23.56.',
              },
            },
          ],
        },
        {
          ...
          steps: [
            ...
            },
            {
              ...
              blanks: [{ answer: 1.26 }],
              hints: [
                { en: 'V = 2pi × integral from 0 to 1 of x^4 dx.', id: 'V = 2pi × integral dari 0 sampai 1 dari x^4 dx.' },
              ],
              explain: {
                en: 'V = 2pi[x^5/5] from 0 to 1 = 2pi/5 ≈ 1.26.',
                id: 'V = 2pi[x^5/5] dari 0 sampai 1 = 2pi/5 ≈ 1.26.',
              },
            },
          ],
        },
      ...
      project: {
        ...
        requirements: [
          ...
          { en: 'A shell integrates 2·pi·(radius)·(height) over the axis perpendicular to the rotation axis.', id: 'Kulit mengintegralkan 2·pi·(jari-jari)·(tinggi) pada sumbu yang tegak lurus terhadap sumbu putarnya.' },
        ],
        tasks: [
          {
