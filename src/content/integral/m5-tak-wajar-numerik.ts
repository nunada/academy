  ...
  submodules: [
    /* ------------------------------------------------------- 5.1 improper integrals */
    {
          ...
          steps: [
            {
              ...
              figure: {
                ...
                caption: {
                  en: 'y = 1/x^2 for x >= 1, shown out to x = 6 — the tail keeps thinning forever, but the total shaded area still converges to exactly 1.',
                  id: 'y = 1/x^2 untuk x >= 1, ditampilkan sampai x = 6 — ekornya terus menipis selamanya, tetapi total luas bayangannya tetap konvergen ke tepat 1.',
                },
              },
            },
            {
            ...
            },
            {
              ...
              id: 'q2',
              prompt: {
                en: 'Which integral converges: the integral from 1 to infinity of 1/x^3 dx, or the integral from 1 to infinity of 1/sqrt(x) dx?',
                id: 'Manakah yang konvergen: integral dari 1 sampai tak hingga dari 1/x^3 dx, atau integral dari 1 sampai tak hingga dari 1/sqrt(x) dx?',
              },
              options: [
            ...
            },
            {
              ...
              id: 'm1',
              prompt: {
                en: 'Evaluate the integral from 1 to infinity of 1/x^3 dx.',
                id: 'Hitung integral dari 1 sampai tak hingga dari 1/x^3 dx.',
              },
              blanks: [{ answer: 0.5 }],
              hints: [
                { en: 'Integral from 1 to t of x^{-3} dx = [-1/(2x^2)] from 1 to t.', id: 'Integral dari 1 sampai t dari x^{-3} dx = [-1/(2x^2)] dari 1 sampai t.' },
              ],
              explain: {
                en: 'lim(t→∞) (-1/(2t^2) + 1/2) = 0 + 1/2 = 1/2.',
                id: 'lim(t→∞) (-1/(2t^2) + 1/2) = 0 + 1/2 = 1/2.',
              },
            },
          ],
        },
        {
          ...
          steps: [
            ...
            },
            {
              ...
              id: 'q1',
              prompt: {
                en: 'Why is the integral from 0 to 1 of 1/x dx improper?',
                id: 'Mengapa integral dari 0 sampai 1 dari 1/x dx tak wajar?',
              },
              options: [
            ...
            },
            {
              ...
              id: 'm1',
              prompt: {
                en: 'Evaluate the integral from 0 to 1 of x^{-1/3} dx.',
                id: 'Hitung integral dari 0 sampai 1 dari x^{-1/3} dx.',
              },
              blanks: [{ answer: 1.5 }],
              hints: [
                { en: 'Antiderivative: (3/2)x^{2/3}. Take the limit as the lower bound approaches 0.', id: 'Antiturunan: (3/2)x^{2/3}. Ambil limitnya ketika batas bawah mendekati 0.' },
              ],
              explain: {
                en: 'lim(t→0+) [(3/2)(1) - (3/2)t^{2/3}] = 3/2 - 0 = 1.5.',
                id: 'lim(t→0+) [(3/2)(1) - (3/2)t^{2/3}] = 3/2 - 0 = 1.5.',
              },
            },
          ],
        },
      ...
      project: {
        ...
        tasks: [
          {
            prompt: { en: 'Evaluate the integral from 2 to infinity of 1/x^2 dx.', id: 'Hitung integral dari 2 sampai tak hingga dari 1/x^2 dx.' },
            blanks: [{ answer: 0.5 }],
            solution: ['\\lim_{t\\to\\infty}\\left(-\\tfrac1t+\\tfrac12\\right) = \\tfrac12'],
          },
          {
            prompt: { en: 'Evaluate the integral from 0 to 4 of 1/sqrt(x) dx.', id: 'Hitung integral dari 0 sampai 4 dari 1/sqrt(x) dx.' },
            blanks: [{ answer: 4 }],
            solution: ['\\lim_{t\\to0^+}\\left(2\\sqrt4-2\\sqrt t\\right) = 4-0 = 4'],
          },
          {
            prompt: { en: 'Evaluate the integral from 1 to infinity of e^{-x} dx.', id: 'Hitung integral dari 1 sampai tak hingga dari e^{-x} dx.' },
    ...
    /* -------------------------------------------------- 5.2 numerical integration */
    {
      ...
      lessons: [
        {
          ...
          steps: [
            ...
            },
            {
              ...
              id: 'm1',
              prompt: {
                en: 'Use the trapezoidal rule with n = 4 to estimate the integral from 0 to 4 of sqrt(x) dx. Heights at x = 0, 1, 2, 3, 4 are 0, 1, 1.4142, 1.7321, 2.',
                id: 'Pakai aturan trapesium dengan n = 4 untuk menaksir integral dari 0 sampai 4 dari sqrt(x) dx. Tinggi di x = 0, 1, 2, 3, 4 adalah 0, 1, 1.4142, 1.7321, 2.',
              },
              blanks: [{ label: 'T_4 \\approx', answer: 5.146, tol: 0.02 }],
              hints: [
                { en: 'T_4 = (1/2)[f(0) + 2f(1) + 2f(2) + 2f(3) + f(4)].', id: 'T_4 = (1/2)[f(0) + 2f(1) + 2f(2) + 2f(3) + f(4)].' },
              ],
              explain: {
                en: 'T_4 = 0.5[0 + 2(1) + 2(1.4142) + 2(1.7321) + 2] = 0.5[0+2+2.8284+3.4642+2] = 0.5(10.2926) ≈ 5.146.',
                id: 'T_4 = 0.5[0 + 2(1) + 2(1.4142) + 2(1.7321) + 2] = 0.5[0+2+2.8284+3.4642+2] = 0.5(10.2926) ≈ 5.146.',
              },
            },
          ],
        },
        {
          ...
          steps: [
            ...
            },
            {
              ...
              blanks: ['2', '4'],
              explain: {
                en: 'The pattern always alternates 4, 2, 4, 2, ..., 4 between the two endpoints, regardless of how many strips there are (as long as n is even).',
                id: 'Polanya selalu berselang-seling 4, 2, 4, 2, ..., 4 di antara kedua titik ujungnya, tak peduli berapa banyak jalurnya (selama n genap).',
              },
            },
            {
              kind: 'math',
              id: 'm1',
              prompt: {
                en: 'Use Simpson\'s Rule with n = 4 to estimate the integral from 0 to 4 of sqrt(x) dx. Heights at x = 0, 1, 2, 3, 4 are 0, 1, 1.4142, 1.7321, 2.',
                id: 'Pakai Aturan Simpson dengan n = 4 untuk menaksir integral dari 0 sampai 4 dari sqrt(x) dx. Tinggi di x = 0, 1, 2, 3, 4 adalah 0, 1, 1.4142, 1.7321, 2.',
              },
              blanks: [{ label: 'S_4 \\approx', answer: 5.25, tol: 0.02 }],
              hints: [
                { en: 'S_4 = (1/3)[f(0) + 4f(1) + 2f(2) + 4f(3) + f(4)].', id: 'S_4 = (1/3)[f(0) + 4f(1) + 2f(2) + 4f(3) + f(4)].' },
              ],
              explain: {
                en: 'S_4 = (1/3)[0 + 4(1) + 2(1.4142) + 4(1.7321) + 2] = (1/3)[0+4+2.8284+6.9284+2] = (1/3)(15.757) ≈ 5.25 — closer than the trapezoidal estimate to the true value of about 5.33.',
                id: 'S_4 = (1/3)[0 + 4(1) + 2(1.4142) + 4(1.7321) + 2] = (1/3)[0+4+2.8284+6.9284+2] = (1/3)(15.757) ≈ 5.25 — lebih dekat dari taksiran trapesium terhadap nilai sebenarnya sekitar 5.33.',
              },
            },
          ],
        },
      ...
      project: {
        ...
        tasks: [
          {
            prompt: { en: 'For f(x) = 1/(1+x^2) on [0, 2] with n = 4, heights at x = 0, 0.5, 1, 1.5, 2 are 1, 0.8, 0.5, 0.3077, 0.2. Estimate with the trapezoidal rule.', id: 'Untuk f(x) = 1/(1+x^2) pada [0, 2] dengan n = 4, tinggi di x = 0, 0.5, 1, 1.5, 2 adalah 1, 0.8, 0.5, 0.3077, 0.2. Taksir dengan aturan trapesium.' },
          ...
          {
            prompt: { en: 'The true value of this integral is arctan(2) ≈ 1.1071. Which estimate is closer: type 1 for trapezoidal, 2 for Simpson.', id: 'Nilai sebenarnya integral ini adalah arctan(2) ≈ 1.1071. Taksiran mana yang lebih dekat: ketik 1 untuk trapesium, 2 untuk Simpson.' },
            blanks: [{ answer: 2 }],
