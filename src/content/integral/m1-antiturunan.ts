  ...
  submodules: [
      ...
      lessons: [
        {
          ...
          steps: [
            ...
            },
            {
              ...
              answer: 0,
              explain: {
                en: 'The derivative of any constant is 0, so adding a different constant to F never changes F prime. Reversing the derivative can only recover F up to that lost constant.',
                id: 'Turunan konstanta apa pun adalah 0, jadi menambahkan konstanta berbeda ke F tak pernah mengubah F aksen. Membalik turunan hanya bisa memulihkan F hingga konstanta yang hilang itu.',
              },
            },
            {
              kind: 'quiz',
            ...
            },
            {
              ...
              explain: {
                en: 'd/dx(2x^3 - 4) = 6x^2: a match. d/dx(3x^3) = 9x^2: not a match — the coefficient is wrong.',
                id: 'd/dx(2x^3 - 4) = 6x^2: cocok. d/dx(3x^3) = 9x^2: tidak cocok — koefisiennya salah.',
              },
            },
          ],
        },
    ...
    /* --------------------------------------- 1.2 basic rules and initial value problems */
    {
      ...
      lessons: [
        {
          ...
          steps: [
            ...
            },
            {
              ...
              math: true,
              prompt: {
                en: 'Complete the antiderivative of f(x) = 6x^2 - 4sin x.',
                id: 'Lengkapi antiturunan dari f(x) = 6x^2 - 4sin x.',
              },
              template: '\\int (6x^2 - 4\\sin x)\\,dx = ___x^3 + ___\\cos x + C',
              blanks: ['2', '4'],
              explain: {
                en: 'Term by term: 6x^2 gives 2x^3, and -4 sin x gives -4 · (-cos x) = 4 cos x.',
                id: 'Suku demi suku: 6x^2 memberi 2x^3, dan -4 sin x memberi -4 · (-cos x) = 4 cos x.',
              },
            },
            {
              kind: 'math',
        ...
        },
        {
          ...
          steps: [
            ...
            },
            {
              ...
              id: 'm1',
              prompt: {
                en: 'Find F with F prime(x) = 4x - 1 and F(2) = 10, then evaluate F(0).',
                id: 'Cari F dengan F aksen(x) = 4x - 1 dan F(2) = 10, lalu hitung F(0).',
              },
              blanks: [{ label: 'F(0) =', answer: 4 }],
              hints: [
      ...
      project: {
        ...
        tasks: [
          {
            prompt: { en: 'Find F with F prime(x) = 3x^2 + 2 and F(0) = 5, then evaluate F(2).', id: 'Cari F dengan F aksen(x) = 3x^2 + 2 dan F(0) = 5, lalu hitung F(2).' },
            blanks: [{ answer: 17 }],
            solution: ['F(x) = x^3+2x+C, \\ F(0)=C=5 \\Rightarrow F(x)=x^3+2x+5, \\ F(2)=8+4+5=17'],
          },
          {
            prompt: { en: 'Find F with F prime(x) = cos x and F(0) = 2, then evaluate F(pi/2).', id: 'Cari F dengan F aksen(x) = cos x dan F(0) = 2, lalu hitung F(pi/2).' },
            blanks: [{ answer: 3 }],
