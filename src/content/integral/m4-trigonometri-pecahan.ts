  ...
  submodules: [
    /* ------------------------------------- 4.1 trig integrals and substitution */
    {
      ...
      lessons: [
        {
          ...
          steps: [
            ...
            },
            {
              ...
              id: 'm1',
              prompt: {
                en: 'Evaluate the integral from 0 to pi of sin^3(x) dx.',
                id: 'Hitung integral dari 0 sampai pi dari sin^3(x) dx.',
              },
              blanks: [{ answer: 4 / 3 }],
              hints: [
        ...
        },
        {
          ...
          steps: [
            ...
            },
            {
              ...
              id: 'q1',
              prompt: {
                en: 'Why does the substitution x = a sin(theta) clear the square root in sqrt(a^2 - x^2)?',
                id: 'Mengapa substitusi x = a sin(theta) menghilangkan akar dalam sqrt(a^2 - x^2)?',
              },
              options: [
                { en: 'a^2 - a^2 sin^2(theta) factors as a^2 cos^2(theta) by the Pythagorean identity, and the square root of a perfect square is clean', id: 'a^2 - a^2 sin^2(theta) difaktorkan sebagai a^2 cos^2(theta) oleh identitas Pythagoras, dan akar dari kuadrat sempurna itu bersih' },
              ...
              answer: 0,
              explain: {
                en: 'sin^2 + cos^2 = 1 rearranges to 1 - sin^2(theta) = cos^2(theta), which is exactly what a^2 - a^2 sin^2(theta) becomes after factoring out a^2 — a perfect square under the root, for any a.',
                id: 'sin^2 + cos^2 = 1 ditata ulang menjadi 1 - sin^2(theta) = cos^2(theta), persis yang menjadi a^2 - a^2 sin^2(theta) setelah memfaktorkan a^2 — kuadrat sempurna di bawah akar, untuk a berapa pun.',
              },
            },
            {
              kind: 'quiz',
              ...
              answer: 0,
              explain: {
                en: 'y = sqrt(4 - x^2) traces the upper half of the circle x^2 + y^2 = 4, so this region is precisely a quarter-disk of radius 2 — its area was always going to match (1/4)pi(2^2) = pi.',
                id: 'y = sqrt(4 - x^2) menjejaki separuh atas lingkaran x^2 + y^2 = 4, sehingga daerah ini persis seperempat cakram berjari-jari 2 — luasnya memang akan cocok dengan (1/4)pi(2^2) = pi.',
              },
            },
            {
              kind: 'math',
              id: 'm1',
              prompt: {
                en: 'Use trigonometric substitution to evaluate the integral from 0 to 3 of sqrt(9 - x^2) dx.',
                id: 'Pakai substitusi trigonometri untuk menghitung integral dari 0 sampai 3 dari sqrt(9 - x^2) dx.',
              },
              blanks: [{ label: '=', answer: 2.25 * Math.PI }],
              hints: [
                { en: 'This is a quarter-circle of radius 3 — the area formula (1/4)pi r^2 checks the answer directly.', id: 'Ini seperempat lingkaran berjari-jari 3 — rumus luas (1/4)pi r^2 memeriksa jawabannya langsung.' },
              ],
              explain: {
                en: 'x = 3sin(theta) gives 9∫[0,pi/2] cos^2(theta) dtheta = 9(pi/4) = 9pi/4 ≈ 7.07, matching (1/4)pi(3^2) = 9pi/4.',
                id: 'x = 3sin(theta) memberi 9∫[0,pi/2] cos^2(theta) dtheta = 9(pi/4) = 9pi/4 ≈ 7.07, cocok dengan (1/4)pi(3^2) = 9pi/4.',
              },
            },
          ],
        },
      ...
      project: {
        ...
        requirements: [
          ...
          { en: 'A square root of a^2 - x^2 clears completely under x = a sin(theta).', id: 'Akar dari a^2 - x^2 hilang sepenuhnya di bawah x = a sin(theta).' },
        ],
        tasks: [
          {
            prompt: { en: 'Evaluate the integral from 0 to pi/2 of cos^3(x) dx.', id: 'Hitung integral dari 0 sampai pi/2 dari cos^3(x) dx.' },
            blanks: [{ answer: 2 / 3 }],
            solution: ['F(x) = \\sin x - \\dfrac{\\sin^3 x}{3}, \\quad F(\\pi/2)-F(0) = \\left(1-\\tfrac13\\right)-0 = \\tfrac23'],
          },
          {
            prompt: { en: 'Evaluate the integral from 0 to pi of sin^2(x) dx.', id: 'Hitung integral dari 0 sampai pi dari sin^2(x) dx.' },
            blanks: [{ answer: Math.PI / 2 }],
            solution: ['F(x) = \\dfrac{x}{2}-\\dfrac{\\sin 2x}{4}, \\quad F(\\pi)-F(0) = \\dfrac{\\pi}{2} - 0 = \\dfrac{\\pi}{2} \\approx 1{,}57'],
          },
          {
            prompt: { en: 'Use trigonometric substitution to evaluate the integral from 0 to 1 of sqrt(1 - x^2) dx.', id: 'Pakai substitusi trigonometri untuk menghitung integral dari 0 sampai 1 dari sqrt(1 - x^2) dx.' },
    ...
    /* ------------------------------------------------------ 4.2 partial fractions */
    {
      ...
      lessons: [
        {
          ...
          steps: [
            ...
            },
            {
              ...
              math: true,
              prompt: {
                en: 'Decompose (7x - 6)/((x-2)(x-1)) into partial fractions by finding A and B.',
                id: 'Uraikan (7x - 6)/((x-2)(x-1)) menjadi pecahan parsial dengan mencari A dan B.',
              },
            ...
            },
            {
              ...
              id: 'm1',
              prompt: {
                en: 'Decompose 4/((x-3)(x+1)) as A/(x-3) + B/(x+1). Find A and B.',
                id: 'Uraikan 4/((x-3)(x+1)) sebagai A/(x-3) + B/(x+1). Cari A dan B.',
              },
              blanks: [
                { label: 'A =', answer: 1 },
                { label: 'B =', answer: -1 },
        ...
        },
        {
          ...
          steps: [
            ...
            },
            {
              ...
              answer: 0,
              explain: {
                en: 'k/(x - r) is exactly Module 1\'s exceptional power-rule case, just shifted — its antiderivative is k · ln|x - r| + C.',
                id: 'k/(x - r) persis kasus pengecualian aturan pangkat Modul 1, hanya digeser — antiturunannya adalah k · ln|x - r| + C.',
              },
            },
            {
              kind: 'order',
              ...
              math: true,
              prompt: {
                en: 'Order the full solution for the integral of (7x-6)/((x-2)(x-1)) dx, using A = 8, B = -1 from the last lesson.',
                id: 'Susun penyelesaian lengkap untuk integral dari (7x-6)/((x-2)(x-1)) dx, memakai A = 8, B = -1 dari pelajaran sebelumnya.',
              },
              lines: [
            ...
            },
            {
              ...
              id: 'm1',
              prompt: {
                en: 'Evaluate the integral from 4 to 5 of 4/((x-3)(x+1)) dx using A = 1, B = -1 from the last lesson. (Round to two decimal places.)',
                id: 'Hitung integral dari 4 sampai 5 dari 4/((x-3)(x+1)) dx memakai A = 1, B = -1 dari pelajaran sebelumnya. (Bulatkan ke dua desimal.)',
              },
              blanks: [{ answer: 0.51 }],
              hints: [
              ...
              explain: {
                en: 'F(5) = ln2 - ln6 ≈ -1.10. F(4) = ln1 - ln5 ≈ -1.61. F(5) - F(4) ≈ 0.51.',
                id: 'F(5) = ln2 - ln6 ≈ -1.10. F(4) = ln1 - ln5 ≈ -1.61. F(5) - F(4) ≈ 0.51.',
              },
            },
          ],
        },
      ...
      project: {
        ...
        tasks: [
          {
            prompt: { en: 'Decompose 3/((x-1)(x+2)) as A/(x-1) + B/(x+2). Find A.', id: 'Uraikan 3/((x-1)(x+2)) sebagai A/(x-1) + B/(x+2). Cari A.' },
            blanks: [{ answer: 1 }],
            solution: ['3 = A(x+2)+B(x-1); \\text{ at } x=1: 3=3A \\Rightarrow A=1'],
          },
          {
            prompt: { en: 'Using A = 1 and B = -1 for 3/((x-1)(x+2)), evaluate the integral from 2 to 4 of it. (Round to two decimal places.)', id: 'Memakai A = 1 dan B = -1 untuk 3/((x-1)(x+2)), hitung integral dari 2 sampai 4. (Bulatkan ke dua desimal.)' },
            blanks: [{ answer: 0.69 }],
            solution: ['F(x)=\\ln|x-1|-\\ln|x+2|', 'F(4)-F(2) = (\\ln3-\\ln6)-(\\ln1-\\ln4) \\approx -0{,}693-(-1{,}386) = 0{,}69'],
          },
          {
            prompt: { en: 'Evaluate the integral from 5 to 6 of 4/((x-3)(x+1)) dx using A = 1, B = -1. (Round to two decimal places.)', id: 'Hitung integral dari 5 sampai 6 dari 4/((x-3)(x+1)) dx memakai A = 1, B = -1. (Bulatkan ke dua desimal.)' },
            blanks: [{ answer: 0.25 }],
