  ...
  submodules: [
    /* --------------------------------------------------------- 3.1 u-substitution */
    {
      ...
      lessons: [
        {
          ...
          steps: [
            ...
            },
            {
              ...
              id: 'q2',
              prompt: {
                en: 'For the integral of x times cos(x^2) dx, what should u be?',
                id: 'Untuk integral dari x kali cos(x^2) dx, apa yang seharusnya menjadi u?',
              },
              options: [
                { en: 'x^2', id: 'x^2' },
                { en: 'cos(x)', id: 'cos(x)' },
            ...
            },
            {
              ...
              math: true,
              prompt: {
                en: 'Complete the substitution for the integral of 3x^2(x^3+4)^4 dx.',
                id: 'Lengkapi substitusi untuk integral dari 3x^2(x^3+4)^4 dx.',
              },
        ...
        },
        {
          ...
          steps: [
            ...
            },
            {
              ...
              id: 'm1',
              prompt: {
                en: 'Evaluate the integral from 0 to pi/2 of sin(x)cos(x) dx using u = sin(x).',
                id: 'Hitung integral dari 0 sampai pi/2 dari sin(x)cos(x) dx memakai u = sin(x).',
              },
              blanks: [{ answer: 0.5 }],
              hints: [
              ...
              explain: {
                en: 'The integral becomes the integral from 0 to 1 of u du = [u^2/2] from 0 to 1 = 0.5.',
                id: 'Integralnya menjadi integral dari 0 sampai 1 dari u du = [u^2/2] dari 0 sampai 1 = 0.5.',
              },
            },
          ],
        },
      ...
      project: {
        ...
        tasks: [
          ...
          {
            prompt: { en: 'Evaluate the integral from 0 to 2 of x·e^(x^2) dx. (Round to two decimal places.)', id: 'Hitung integral dari 0 sampai 2 dari x·e^(x^2) dx. (Bulatkan ke dua desimal.)' },
            blanks: [{ answer: 26.8 }],
            solution: ['u=x^2, \\ du=2x\\,dx, \\quad \\int_0^4 \\tfrac12 e^u\\,du = \\tfrac12(e^4-1) \\approx 26{,}80'],
          },
          {
            prompt: { en: 'Evaluate the integral from 0 to 1 of (3x^2)/(x^3+1) dx. (Round to two decimal places.)', id: 'Hitung integral dari 0 sampai 1 dari (3x^2)/(x^3+1) dx. (Bulatkan ke dua desimal.)' },
            blanks: [{ answer: 0.69 }],
    ...
    /* -------------------------------------------------- 3.2 integration by parts */
    {
      ...
      lessons: [
        {
          ...
          steps: [
            ...
            },
            {
              ...
              answer: 0,
              explain: {
                en: 'Integrating both sides of the product rule d/dx[uv] = u\'v + uv\' and rearranging produces exactly the integration by parts formula.',
                id: 'Mengintegralkan kedua ruas aturan hasil kali d/dx[uv] = u\'v + uv\' dan menata ulangnya menghasilkan persis rumus integral parsial.',
              },
            },
            {
              kind: 'quiz',
              id: 'q2',
              prompt: {
                en: 'For the integral of x·ln(x) dx, which choice of u simplifies best under differentiation?',
                id: 'Untuk integral dari x·ln(x) dx, pilihan u mana yang paling menyederhana di bawah penurunan?',
              },
              options: [
            ...
            },
            {
              ...
              math: true,
              prompt: {
                en: 'Complete the integration by parts setup and result for the integral of x·sin(x) dx.',
                id: 'Lengkapi penyusunan integral parsial dan hasilnya untuk integral dari x·sin(x) dx.',
              },
            ...
            },
            {
              ...
              id: 'm1',
              prompt: {
                en: 'Evaluate the integral from 0 to 1 of x·e^x dx. (Round to two decimal places.)',
                id: 'Hitung integral dari 0 sampai 1 dari x·e^x dx. (Bulatkan ke dua desimal.)',
              },
              blanks: [{ answer: 1 }],
              hints: [
        ...
        },
        {
          ...
          steps: [
            ...
            },
            {
              ...
              id: 'q1',
              prompt: {
                en: 'Why does the integral of e^x sin(x) dx need a different trick than the integral of x^2 e^x dx?',
                id: 'Mengapa integral dari e^x sin(x) dx memerlukan trik berbeda dari integral dari x^2 e^x dx?',
              },
              options: [
              ...
              answer: 0,
              explain: {
                en: 'x^2 e^x shrinks with each pass because differentiating the polynomial factor lowers its degree. e^x sin(x) cycles between sin and cos under differentiation and integration, so two passes bring back the starting integral rather than something new.',
                id: 'x^2 e^x menyusut dengan tiap putaran sebab menurunkan faktor polinomnya menurunkan derajatnya. e^x sin(x) berputar antara sin dan cos di bawah penurunan dan pengintegralan, sehingga dua putaran mengembalikan integral awalnya alih-alih sesuatu yang baru.',
              },
            },
            {
              kind: 'order',
              ...
              math: true,
              prompt: {
                en: 'Order the steps that solve the integral from e^x cos(x) dx circular case.',
                id: 'Susun langkah yang menyelesaikan kasus melingkar integral dari e^x cos(x) dx.',
              },
              lines: [
            ...
            },
            {
              ...
              id: 'm1',
              prompt: {
                en: 'Evaluate the integral from 0 to 1 of x^2 e^x dx. (Round to two decimal places.)',
                id: 'Hitung integral dari 0 sampai 1 dari x^2 e^x dx. (Bulatkan ke dua desimal.)',
              },
              blanks: [{ answer: 0.72 }],
              hints: [
              ...
              explain: {
                en: 'F(1) - F(0) = (e - 2e + 2e) - (0 - 0 + 2) = e - 2 ≈ 0.72.',
                id: 'F(1) - F(0) = (e - 2e + 2e) - (0 - 0 + 2) = e - 2 ≈ 0.72.',
              },
            },
          ],
        },
      ...
      project: {
        ...
        tasks: [
          {
            prompt: { en: 'Evaluate the integral from 1 to e of ln(x) dx. (Round to two decimal places.)', id: 'Hitung integral dari 1 sampai e dari ln(x) dx. (Bulatkan ke dua desimal.)' },
            blanks: [{ answer: 1 }],
            solution: ['u=\\ln x, \\ dv=dx \\Rightarrow F(x)=x\\ln x - x, \\quad F(e)-F(1) = (e-e)-(0-1) = 1'],
          },
          {
            prompt: { en: 'Evaluate the integral from 0 to 1 of x^2·sin(x) dx using two passes. (Round to two decimal places.)', id: 'Hitung integral dari 0 sampai 1 dari x^2·sin(x) dx memakai dua putaran. (Bulatkan ke dua desimal.)' },
            blanks: [{ answer: 0.22 }],
