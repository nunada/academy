  ...
  submodules: [
    /* ------------------------------------------------------- 1.1 rules & aim */
    {
      ...
      lessons: [
        {
          ...
          steps: [
            ...
            },
            {
              ...
              body: {
                en: 'For these exercises the CSS goes in a `<style>` block. A real site puts it in its own `.css` file, linked from the head with `<link rel="stylesheet" href="gaya.css">` — same rules, one file serving every page.',
          ...
          steps: [
            {
              ...
              body: {
                en: 'A bare `p` hits every paragraph. `.penting` hits every element carrying `class="penting"`, and `#judul` hits the single element with `id="judul"`. Class is the workhorse; reach for id rarely.',
            ...
            },
            {
              kind: 'web',
              id: 'w1',
              html: '<h1 id="utama">Judul</h1>\n<p class="catatan">Catatan pertama.</p>\n<p>Paragraf biasa.</p>\n<div class="kotak"><p class="catatan">Catatan di dalam kotak.</p></div>',
              prompt: {
                en: 'Colour `#utama` teal, every `.catatan` crimson, and give paragraphs inside `.kotak` a `lightyellow` background.',
              ...
              hints: [
                ...
                { en: 'The last one is a descendant selector: `.kotak p`', id: 'Yang terakhir adalah selektor keturunan: `.kotak p`' },
              ],
              solution:
      ...
      project: {
        ...
        requirements: [
          { en: '`.kartu` gets a `whitesmoke` background.', id: '`.kartu` diberi latar `whitesmoke`.' },
          { en: '`.judul` is `darkslateblue` and centred.', id: '`.judul` berwarna `darkslateblue` dan rata tengah.' },
          { en: '`.isi` is `dimgray`.', id: '`.isi` berwarna `dimgray`.' },
    ...
    /* ------------------------------------------------------- 1.2 text & colour */
    {
      ...
      lessons: [
        {
          ...
          steps: [
            ...
            },
            {
              ...
              prompt: {
                en: 'Set the whole page to a `sans-serif` stack, make `p` 18px with a line-height of 1.6, and align `.tanda` to the right.',
              ...
              hints: [
                { en: 'Three rules: body, p, and .tanda.', id: 'Tiga aturan: body, p, dan .tanda.' },
      ...
      project: {
        ...
        requirements: [
          ...
          { en: '`.ringkasan` is bold and `#334155`.', id: '`.ringkasan` tebal dan berwarna `#334155`.' },
          { en: '`.penutup` is right-aligned.', id: '`.penutup` rata kanan.' },
        ...
        hints: [
          ...
          { en: 'Colour every p with #1f2937, then let .ringkasan set its own colour.', id: 'Warnai semua p dengan #1f2937, lalu biarkan .ringkasan menetapkan warnanya sendiri.' },
        ],
        solution:
