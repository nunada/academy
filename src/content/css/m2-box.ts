    ...
    /* ------------------------------------------------------- 2.1 the four layers */
    {
      ...
      lessons: [
        {
          ...
          steps: [
            ...
            },
            {
              kind: 'web',
              id: 'w1',
              html: '<div class="peringatan">Tugas dikumpulkan besok.</div>',
              prompt: {
                en: 'Give `.peringatan` 16px of padding, a 2px solid `#f59e0b` border, an 8px radius, and 24px of margin.',
        ...
        },
        {
          ...
          steps: [
            ...
            },
            {
              kind: 'web',
              id: 'w1',
              html: '<div class="kartu">Kartu dengan lebar yang bisa diprediksi.</div>',
              prompt: {
                en: 'Set `box-sizing: border-box` on every element, then give `.kartu` a width of 320px, 24px of padding, and a 1px solid `#cbd5e1` border — so its total width really is 320px.',
      ...
      project: {
        ...
        requirements: [
          ...
          { en: '`.profil` is 360px wide with 28px of padding.', id: '`.profil` selebar 360px dengan padding 28px.' },
          ...
          { en: '`.nama` has no space above it (`margin-top: 0`).', id: '`.nama` tanpa ruang di atasnya (`margin-top: 0`).' },
          { en: '`.peran` is `#64748b`; `.bio` has a line-height of 1.6.', id: '`.peran` berwarna `#64748b`; `.bio` ber-line-height 1,6.' },
        ],
        starter: '* {\n  box-sizing: border-box;\n}\n\n.profil {\n\n}\n',
        tests: [
          {
        ...
        hints: [
          ...
          { en: 'Five rules is plenty: *, .profil, .nama, .peran, .bio.', id: 'Lima aturan sudah cukup: *, .profil, .nama, .peran, .bio.' },
        ],
        solution:
    ...
    /* ------------------------------------------------------------ 2.2 display */
    {
      ...
      lessons: [
        {
          ...
          steps: [
            ...
            },
            {
              kind: 'web',
              id: 'w1',
              html: '<span class="lencana">Python</span>\n<span class="lencana">HTML</span>\n<span class="lencana">CSS</span>\n<p class="draf">Belum siap tayang.</p>',
              prompt: {
                en: 'Make every `.lencana` an inline-block 100px wide with 8px of padding and a `#e0e7ff` background, and hide `.draf` completely.',
              ...
              hints: [
                ...
                { en: 'Two rules: one for .lencana, one for .draf.', id: 'Dua aturan: satu untuk .lencana, satu untuk .draf.' },
              ],
              solution:
        ...
        },
        {
          ...
          steps: [
            ...
            },
            {
              ...
              prompt: {
                en: 'Centre `.wadah` on the page with a max-width of 400px, and centre the text inside it too.',
              ...
              hints: [
                { en: 'Three declarations, all on .wadah.', id: 'Tiga deklarasi, semuanya pada .wadah.' },
      ...
      project: {
        ...
        requirements: [
          ...
          { en: '`.halaman` is centred, max-width 480px, 32px padding, 2px solid `#d4c58a` border.', id: '`.halaman` terpusat, max-width 480px, padding 32px, border solid 2px `#d4c58a`.' },
          { en: 'The text inside `.halaman` is centred.', id: 'Teks di dalam `.halaman` rata tengah.' },
          { en: 'Each `.cap` is an inline-block, 90px wide, 6px padding, `#fef3c7` background.', id: 'Tiap `.cap` berupa inline-block, lebar 90px, padding 6px, latar `#fef3c7`.' },
          { en: '`.rahasia` is hidden with `display: none`.', id: '`.rahasia` disembunyikan dengan `display: none`.' },
        ],
        starter: '* {\n  box-sizing: border-box;\n}\n\n.halaman {\n\n}\n',
        tests: [
          {
        ...
        hints: [
          ...
          { en: 'Four rules: *, .halaman, .cap, .rahasia.', id: 'Empat aturan: *, .halaman, .cap, .rahasia.' },
        ],
        solution:
