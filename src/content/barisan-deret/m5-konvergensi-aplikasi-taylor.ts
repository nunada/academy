  ...
  submodules: [
    ...
    /* ------------------------------------------------- 9.10 applications of taylor series */
    {
      ...
      lessons: [
        {
          id: 'der-m5-s2-l1',
          title: { en: 'Integrating a Function With No Elementary Antiderivative', id: 'Mengintegralkan Fungsi Tanpa Antiturunan Elementer' },
          goal: {
            en: 'Approximate a definite integral by integrating its integrand\'s Taylor series term by term.',
            id: 'Menghampiri integral tentu dengan mengintegralkan deret Taylor integrandnya suku demi suku.',
          },
          xp: 20,
          steps: [
            {
      ...
      project: {
        ...
        title: { en: 'Applications of Taylor Series', id: 'Aplikasi Deret Taylor' },
        brief: {
          en: 'A series-based integral approximation and two limits evaluated by substitution.',
          id: 'Sebuah hampiran integral berbasis deret dan dua limit yang dievaluasi lewat substitusi.',
        },
        requirements: [
