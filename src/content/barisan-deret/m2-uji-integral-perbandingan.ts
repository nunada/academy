          ...
          steps: [
            ...
            },
            {
              ...
              figure: {
                ...
                items: [
                  { t: 'dot', x: 'p', y: 1, color: 'result' },
                  { t: 'vline', x: 1, color: 'muted', dashed: true, label: 'p=1' },
                ],
                caption: {
                  en: 'Drag $p$ across the line $p=1$: everything to the right converges (the improper integral has a finite area), everything to the left diverges — exactly the boundary the Techniques of Integration course already drew.',
                  id: 'Geser $p$ melewati garis $p=1$: segalanya di kanan konvergen (integral tak wajarnya berluas hingga), segalanya di kiri divergen — persis batas yang sudah digambar kursus Teknik Pengintegralan.',
                },
              },
            },
            {
