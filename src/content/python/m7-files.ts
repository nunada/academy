  ...
  submodules: [
    /* --------------------------------------------------------- 7.1 read/write */
    {
      ...
      lessons: [
        {
          ...
          steps: [
            ...
            },
            {
              ...
              options: [
                { en: 'Only the line `baru`', id: 'Hanya baris `baru`' },
            ...
            },
            {
              ...
              id: 'f1',
              prompt: {
                en: 'Write `halo` into `pesan.txt`, closing the file automatically.',
                id: 'Tulis `halo` ke `pesan.txt`, dengan penutupan berkas otomatis.',
              },
              template: '___ open("pesan.txt", "___") as f:\n    f.write("halo")',
              blanks: ['with', 'w'],
              explain: {
            ...
            },
            {
              ...
              id: 'w1',
              prompt: {
                en: 'Write the numbers 1 to 5 into `angka.txt`, one per line, then print `Selesai`.',
          ...
          steps: [
            {
              ...
              code: 'with open("kota.txt", "w") as f:\n    f.write("Surabaya\\nMalang\\n")\n\nwith open("kota.txt") as f:\n    for baris in f:\n        print(baris)',
              output: 'Surabaya\n\nMalang\n',
            },
            {
              kind: 'concept',
            ...
            },
            {
              ...
              lines: ['jumlah = 0', 'with open("data.txt") as f:', '    for baris in f:', '        jumlah += 1', 'print(jumlah)'],
              explain: {
            ...
            },
            {
              ...
              starter: '# nilai.txt sudah disiapkan untukmu\n',
              tests: [
                {
              ...
              hints: [
                ...
                { en: 'Each line is text with a newline: int(baris.strip())', id: 'Tiap baris berupa teks dengan baris baru: int(baris.strip())' },
                { en: 'round(sum(angka) / len(angka), 1) gives one decimal.', id: 'round(sum(angka) / len(angka), 1) memberi satu angka desimal.' },
              ],
              solution:
      ...
      project: {
        ...
        requirements: [
          { en: 'Read lines until the user types `selesai`.', id: 'Baca baris sampai pengguna mengetik `selesai`.' },
          { en: 'Append each note to `catatan.txt` — do not erase what was already there.', id: 'Tambahkan tiap catatan ke `catatan.txt` — jangan hapus isi sebelumnya.' },
          { en: 'Then print every note as `1. isi catatan`, numbered from 1.', id: 'Lalu cetak semua catatan sebagai `1. isi catatan`, bernomor mulai 1.' },
          { en: 'If the file does not exist yet, print `Belum ada catatan`.', id: 'Bila berkasnya belum ada, cetak `Belum ada catatan`.' },
        ],
        starter: '# Penyimpan catatan\n',
        tests: [
          {
        ...
        hints: [
          ...
          {
            en: 'enumerate(baris, 1) hands you the number and the line together.',
    ...
    /* ------------------------------------------------------------- 7.2 tables */
    {
      ...
      lessons: [
        {
          ...
          steps: [
            ...
            },
            {
              ...
              template: 'baris = "Ani,17,Surabaya"\nbagian = baris.___(",")\nprint(___(bagian[1]))',
              blanks: ['split', 'int'],
              explain: {
            ...
            },
            {
              ...
              id: 'w1',
              prompt: {
                en: 'Write `baca_baris(baris)` that turns `"Ani,17,Surabaya"` into the dictionary `{"nama": "Ani", "umur": 17, "kota": "Surabaya"}` — with `umur` as a real number.',
              ...
              hints: [
                ...
                { en: 'bagian = baris.split(",")', id: 'bagian = baris.split(",")' },
                {
                  en: 'return {"nama": bagian[0], "umur": int(bagian[1]), "kota": bagian[2]}',
                  id: 'return {"nama": bagian[0], "umur": int(bagian[1]), "kota": bagian[2]}',
                },
              ],
              solution:
                'def baca_baris(baris):\n    bagian = baris.split(",")\n    return {"nama": bagian[0], "umur": int(bagian[1]), "kota": bagian[2]}',
            },
          ],
        },
        {
          ...
          steps: [
            ...
            },
            {
              ...
              id: 'q1',
              prompt: {
                en: 'Why does `nama, nilai = baris.strip().split(",")` fail on the line `Ani,80,extra`?',
            ...
            },
            {
              ...
              id: 'w1',
              prompt: {
                en: '`stok.txt` holds `barang,jumlah` per line. Print the name of every item whose count is 0, one per line. Print nothing if there are none.',
              ...
              starter: '# stok.txt sudah disiapkan untukmu\n',
              tests: [
                {
              ...
              hints: [
                ...
                { en: 'nama, jumlah = baris.strip().split(",") then if int(jumlah) == 0:', id: 'nama, jumlah = baris.strip().split(",") lalu if int(jumlah) == 0:' },
              ],
              solution:
                'with open("stok.txt") as f:\n    for baris in f:\n        if not baris.strip():\n            continue\n        nama, jumlah = baris.strip().split(",")\n        if int(jumlah) == 0:\n            print(nama)',
            },
          ],
        },
      ],
      project: {
        ...
        requirements: [
          { en: '`kelas.txt` holds `nama,nilai` per line. Blank lines must be ignored.', id: '`kelas.txt` berisi `nama,nilai` per baris. Baris kosong harus diabaikan.' },
          { en: 'Print `Jumlah siswa: N`.', id: 'Cetak `Jumlah siswa: N`.' },
          { en: 'Print `Rata-rata: R`, rounded to one decimal.', id: 'Cetak `Rata-rata: R`, dibulatkan satu desimal.' },
          { en: 'Print `Tertinggi: <nama> (<nilai>)`.', id: 'Cetak `Tertinggi: <nama> (<nilai>)`.' },
          { en: 'Then write only the names scoring 70 or more into `lulus.txt`, one per line.', id: 'Lalu tulis hanya nama yang bernilai 70 ke atas ke `lulus.txt`, satu per baris.' },
          { en: 'If the file is missing, print only `Berkas tidak ditemukan`.', id: 'Bila berkasnya tidak ada, cetak hanya `Berkas tidak ditemukan`.' },
        ],
        starter: '# Daftar nilai kelas\n',
        tests: [
          {
        ...
        hints: [
          ...
          { en: 'For the highest score, keep the best row as you loop, like `terbaik` in module 5.', id: 'Untuk nilai tertinggi, simpan baris terbaik sambil mengulang, seperti `terbaik` di modul 5.' },
