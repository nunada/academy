          ...
          steps: [
            {
              ...
              figure: {
                ...
                ySpan: [0, 4],
                items: [
                  { t: 'poly', pts: [[0.3, 1], [2.0, 1], [2.0, 3], [0.3, 3]], color: 'muted', label: '0' },
                  { t: 'poly', pts: [[2.5, 1], [4.2, 1], [4.2, 3], [2.5, 3]], color: 'a', label: '1' },
                  { t: 'poly', pts: [[4.7, 1], [6.4, 1], [6.4, 3], [4.7, 3]], color: 'a', label: '3' },
                  { t: 'poly', pts: [[6.9, 1], [8.6, 1], [8.6, 3], [6.9, 3]], color: 'a', label: '6' },
                  { t: 'poly', pts: [[9.1, 1], [10.8, 1], [10.8, 3], [9.1, 3]], color: 'result', label: '10' },
                  { t: 'vec', from: [2.0, 2], to: [2.5, 2], color: 'muted' },
                  { t: 'vec', from: [4.2, 2], to: [4.7, 2], color: 'muted' },
                  { t: 'vec', from: [6.4, 2], to: [6.9, 2], color: 'muted' },
                  { t: 'vec', from: [8.6, 2], to: [9.1, 2], color: 'muted' },
                ],
                caption: {
                  en: 'total starts at 0 and picks up each n along the way — 0, 1, 3, 6, 10 — the accumulator pattern, one step at a time.',
                  id: 'total dimulai dari 0 dan mengambil tiap n sepanjang jalan — 0, 1, 3, 6, 10 — pola akumulator, selangkah demi selangkah.',
                },
                height: 200,
              },
              code: 'total = 0\nfor n in range(1, 5):\n    total += n\nprint(total)',
