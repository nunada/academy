...
export const COURSES: CourseInfo[] = [
  ...
  },
  {
    ...
    tagline: {
      en: "From secant to tangent, the rules that make differentiation mechanical, and what a derivative is actually for — extreme values, L'Hôpital's Rule, optimization, and Newton's Method included.",
      id: "Dari garis potong ke garis singgung, aturan yang membuat penurunan mekanis, dan untuk apa sebenarnya sebuah turunan — termasuk nilai ekstrem, Aturan L'Hôpital, optimisasi, dan Metode Newton.",
    },
    icon: '📉',
    color: '#a0522d',
    level: { en: 'Intermediate', id: 'Menengah' },
