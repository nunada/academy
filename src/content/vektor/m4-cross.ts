          ...
          steps: [
            {
              ...
              figure: {
                ...
                view: [30, 24],
                items: [
                  { t: 'poly', pts: [[0, 0, 0], [2, 0, 0], [2, 2, 0], [0, 2, 0]], color: 'muted' },
                  { t: 'vec', to: [2, 0, 0], label: 'a', color: 'a' },
                  { t: 'vec', to: [0, 2, 0], label: 'b', color: 'b' },
                  { t: 'vec', to: { cross: [[2, 0, 0], [0, 2, 0]] }, label: 'a × b', color: 'result' },
                  { t: 'vec', to: { cross: [[0, 2, 0], [2, 0, 0]] }, label: 'b × a', color: 'c', dashed: true },
                  { t: 'right', from: [2, 0, 0], to: { cross: [[2, 0, 0], [0, 2, 0]] } },
                ],
                readouts: [
                  { label: 'a × b =', v: { cross: [[2, 0, 0], [0, 2, 0]] }, dp: 0 },
                  { label: 'b × a =', v: { cross: [[0, 2, 0], [2, 0, 0]] }, dp: 0 },
                ],
                caption: {
