  ...
  submodules: [
    {
          ...
          steps: [
            {
              ...
              code: { en: '// TypeScript\nconst age: number = 17;\nconsole.log(age + 1);', id: '// TypeScript\nconst umur: number = 17;\nconsole.log(umur + 1);' },
              output: { en: '// JavaScript result\nconst age = 17;\nconsole.log(age + 1);', id: '// JavaScript hasilnya\nconst umur = 17;\nconsole.log(umur + 1);' },
            },
            {
              kind: 'concept',
              id: 'c2',
              ...
              code: {
                en: 'let amount: number = 5;\namount = 6;        // fine\namount = "six";    // Type \'string\' is not assignable to type \'number\'.',
            ...
            },
            {
              ...
              code: {
                en:
                  'const name = "Nunada";   // string, without being told\n' +
                  'const year = 2024;       // number\n\n' +
                  "function greet(name) {   // ...but this one? TypeScript can't guess.\n" +
                  '  return "Hello, " + name;\n' +
                  '}',
                id:
            ...
            },
            {
              ...
              code: {
                en: 'const city = "Surabaya";\nconst amount: number = 3;\nconst message = city + amount;\nconst wrong: number = city;',
                id: 'const kota = "Surabaya";\nconst jumlah: number = 3;\nconst pesan = kota + jumlah;\nconst salah: number = kota;',
              },
              options: [
            ...
            },
            {
              ...
              template: {
                en: 'function double(n: ___): ___ {\n  return n * 2;\n}',
                id: 'function dua(n: ___): ___ {\n  return n * 2;\n}',
              },
            ...
            },
            {
              ...
              id: 't1',
              prompt: {
                en: 'Write `greet`, taking a `name` of type string and returning the string `Hello, {name}!`. The starter does not compile — read what the compiler says about it.',
                ...
                en: [
                  {
                    ...
                    check:
                      'assert(greet("Nunada") === "Hello, Nunada!", "greet(\\"Nunada\\") should be \\"Hello, Nunada!\\", got: " + JSON.stringify(greet("Nunada")));\n' +
                      'assert(greet("Ani") === "Hello, Ani!", "greet(\\"Ani\\") should be \\"Hello, Ani!\\", got: " + JSON.stringify(greet("Ani")));',
                  },
                  {
                    name: { en: 'A string goes in', id: 'String boleh masuk' },
                    probe: 'const t1 = greet("Ani");',
                  },
                  {
                  ...
                  },
                  {
                    ...
                    probe: 'const t2: number = greet("Ani");',
                    expectError: true,
                    errorCode: 2322,
                  },
                ],
              ...
              hints: [
                ...
                { en: 'The annotation goes right after the name: `name: string`.', id: 'Keterangannya ditulis tepat setelah namanya: `nama: string`.' },
                { en: 'The return type goes after the brackets: `function greet(name: string): string`.', id: 'Tipe kembaliannya ditulis setelah kurungnya: `function sapa(nama: string): string`.' },
              ],
              solution: {
                en: 'function greet(name: string): string {\n  return `Hello, ${name}!`;\n}',
                id: 'function sapa(nama: string): string {\n  return `Halo, ${nama}!`;\n}',
              },
            },
          ],
        },
          ...
          steps: [
            {
              ...
              code: {
                en:
                  ...
                  'area(3, 4, 5);  // Expected 2 arguments, but got 3.',
                id:
            ...
            },
            {
              ...
              code: {
                en:
                  ...
                  '  // title has type string | undefined here\n' +
            ...
            },
            {
              ...
              code: {
                en:
                  ...
                  '}\n\n' +
                  'finalPrice(100000);      // 100000\n' +
                  'finalPrice(100000, 10);  // 90000',
                id:
            ...
            },
            {
              ...
              id: 'q1',
              prompt: {
                en: 'Inside this function, what is the type of `note`?',
                id: 'Di dalam fungsi ini, apa tipe `catatan`?',
              },
              code: {
                en: 'function save(content: string, note?: string) { /* ... */ }',
                id: 'function simpan(isi: string, catatan?: string) { /* ... */ }',
              },
              options: [
            ...
            },
            {
              ...
              id: 't1',
              prompt: {
                en: 'Write `finalPrice(price, discount)` returning the price after a percentage discount, rounded down with `Math.floor`. `discount` may be left out, and then nothing is taken off.',
              ...
              starter: {
                en: 'function finalPrice(price: number, discount: number): number {\n  return price;\n}\n',
                id: 'function hargaAkhir(harga: number, diskon: number): number {\n  return harga;\n}\n',
              },
              tests: {
                en: [
                  {
                    ...
                    check:
                      'assert(finalPrice(100000, 10) === 90000, "finalPrice(100000, 10) should be 90000, got: " + finalPrice(100000, 10));\n' +
                      'assert(finalPrice(75000, 25) === 56250, "finalPrice(75000, 25) should be 56250, got: " + finalPrice(75000, 25));\n' +
                      'assert(finalPrice(9999, 33) === 6699, "finalPrice(9999, 33) should be 6699 (rounded down), got: " + finalPrice(9999, 33));',
                  },
                  {
                    name: { en: 'Without a discount the price is unchanged', id: 'Tanpa diskon harganya tak berubah' },
                    check:
                      'assert(finalPrice(100000) === 100000, "finalPrice(100000) should be 100000, got: " + finalPrice(100000));',
                  },
                  {
                    name: { en: 'One argument is enough', id: 'Satu argumen sudah cukup' },
                    probe: 'const t1 = finalPrice(100000);',
                  },
                  {
                    name: { en: 'A price written as text is refused', id: 'Harga yang ditulis sebagai teks ditolak' },
                    probe: 'finalPrice("100000", 10);',
                    expectError: true,
                    errorCode: 2345,
                  },
                  {
                    name: { en: 'A third argument is refused', id: 'Argumen ketiga ditolak' },
                    probe: 'finalPrice(100000, 10, 5);',
                    expectError: true,
                    errorCode: 2554,
                  },
                ],
      ...
      project: {
        ...
        requirements: [
          { en: '`bmi(weight, height)` takes weight in kg and height in **cm**, and returns the BMI rounded to one decimal.', id: '`bmi(berat, tinggi)` menerima berat dalam kg dan tinggi dalam **cm**, lalu mengembalikan BMI dibulatkan satu desimal.' },
          { en: '`category(value)` returns `Underweight` below 18.5, `Normal` below 25, `Overweight` below 30, and `Obese` otherwise.', id: '`kategori(nilai)` mengembalikan `Kurus` di bawah 18,5, `Normal` di bawah 25, `Gemuk` di bawah 30, dan `Obesitas` selain itu.' },
          { en: '`report(name, weight, height)` returns `"Ani: 20.8 (Normal)"`.', id: '`laporan(nama, berat, tinggi)` mengembalikan `"Ani: 20.8 (Normal)"`.' },
        ...
        starter: {
          en:
            ...
            'function report(name, weight, height) {\n\n}\n',
          id:
          ...
          en: [
            {
              ...
              check:
                'assert(bmi(60, 170) === 20.8, "bmi(60, 170) should be 20.8, got: " + bmi(60, 170));\n' +
                'assert(bmi(45, 170) === 15.6, "bmi(45, 170) should be 15.6, got: " + bmi(45, 170));\n' +
                'assert(bmi(80, 170) === 27.7, "bmi(80, 170) should be 27.7, got: " + bmi(80, 170));\n' +
                'assert(bmi(95, 170) === 32.9, "bmi(95, 170) should be 32.9, got: " + bmi(95, 170));',
            },
            {
              name: { en: 'Every band is named correctly', id: 'Tiap rentangnya dinamai dengan benar' },
              check:
                'const cases = [[15, "Underweight"], [18.4, "Underweight"], [18.5, "Normal"], [24.9, "Normal"], [25, "Overweight"], [29.9, "Overweight"], [30, "Obese"], [40, "Obese"]];\n' +
                'for (const [n, expected] of cases) {\n' +
                '  assert(category(n) === expected, "category(" + n + ") should be " + JSON.stringify(expected) + ", got: " + JSON.stringify(category(n)));\n' +
                '}',
            },
            {
              name: { en: 'The report reads as one line', id: 'Laporannya terbaca sebagai satu baris' },
              check:
                'assert(report("Ani", 60, 170) === "Ani: 20.8 (Normal)", "report(\\"Ani\\", 60, 170) should be \\"Ani: 20.8 (Normal)\\", got: " + JSON.stringify(report("Ani", 60, 170)));\n' +
                'assert(report("Budi", 95, 170) === "Budi: 32.9 (Obese)", "report(\\"Budi\\", 95, 170) should be \\"Budi: 32.9 (Obese)\\", got: " + JSON.stringify(report("Budi", 95, 170)));',
            },
            {
              name: { en: 'The report is built from the other two', id: 'Laporannya dibangun dari dua fungsi lainnya' },
              check:
                'const people = [["Ani", 60, 170], ["Budi", 95, 170], ["Citra", 45, 170], ["Dedi", 80, 170]];\n' +
                'for (const [n, w, h] of people) {\n' +
                '  const expected = n + ": " + bmi(w, h) + " (" + category(bmi(w, h)) + ")";\n' +
                '  assert(report(n, w, h) === expected, "report(" + n + ", " + w + ", " + h + ") should be " + JSON.stringify(expected) + ", got: " + JSON.stringify(report(n, w, h)));\n' +
                '}',
            },
            {
            ...
            },
            {
              ...
              probe: 'const t1: string = bmi(60, 170);',
              expectError: true,
              errorCode: 2322,
            },
            {
              name: { en: 'category is declared to return a string', id: 'kategori dinyatakan mengembalikan string' },
              probe: 'const t2: number = category(20);',
              expectError: true,
              errorCode: 2322,
            },
            {
              name: { en: 'report wants a name, not a number', id: 'laporan meminta nama, bukan angka' },
              probe: 'report(1, 60, 170);',
              expectError: true,
              errorCode: 2345,
            },
            {
              name: { en: 'Called properly, everything is accepted', id: 'Dipanggil dengan benar, semuanya diterima' },
              probe: 'const t3: string = report("Ani", 60, 170);\nconst t4: number = bmi(60, 170);\nconst t5: string = category(20);',
            },
          ],
          id: [
            {
        ...
        solution: {
          en:
            ...
            '  return "Obese";\n' +
            '}\n\n' +
            'function report(name: string, weight: number, height: number): string {\n' +
            '  const value = bmi(weight, height);\n' +
            '  return `${name}: ${value} (${category(value)})`;\n' +
            '}',
          id:
    ...
    },
    {
          ...
          steps: [
            {
              ...
              code: {
                en:
                  ...
                  '  year: number;\n' +
                  '}\n\n' +
                  'const b: Book = { title: "Bumi Manusia", author: "Pramoedya", year: 1980 };',
                id:
                  'interface Buku {\n' +
                  '  judul: string;\n' +
                  '  penulis: string;\n' +
            ...
            },
            {
              ...
              code: {
                en:
                  'const a: Book = { title: "x", author: "y" };\n' +
                  "// Property 'year' is missing\n\n" +
                  'const c: Book = { title: "x", author: "y", year: 1, ttle: "z" };\n' +
            ...
            },
            {
              ...
              id: 'q1',
              prompt: {
                en: 'With `sold?: number`, what does `b.sold + 1` do?',
                id: 'Dengan `terjual?: number`, apa yang terjadi pada `b.terjual + 1`?',
              },
              options: [
                { en: "It is an error — `b.sold` might be undefined", id: 'Itu galat — `b.terjual` mungkin undefined' },
            ...
            },
            {
              ...
              id: 't1',
              prompt: {
                en: 'Declare `interface Book` with `title` and `author` as strings, `year` as a number, and an optional `sold` number. Then write `summarize(b: Book): string` returning `"title — author (year)"`.',
              ...
              starter: {
                en:
                  'interface Book {\n\n}\n\n' +
                  'function summarize(b: Book): string {\n  return "";\n}\n',
                id:
                  'interface Buku {\n\n}\n\n' +
              ...
              tests: {
                en: [
                  ...
                  },
                  {
                    ...
                    probe: 'const t1: Book = { title: "a", author: "b", year: 1, sold: 5 };',
                  },
                  {
                    name: { en: 'sold may be left out', id: 'terjual boleh tidak ada' },
                    probe: 'const t2: Book = { title: "a", author: "b", year: 1 };',
                  },
                  {
                    name: { en: 'A missing year is refused', id: 'tahun yang hilang ditolak' },
                    probe: 'const t3: Book = { title: "a", author: "b" };',
                    expectError: true,
                    errorCode: 2741,
                  },
                  {
                    name: { en: 'A year written as text is refused', id: 'Tahun yang ditulis sebagai teks ditolak' },
                    probe: 'const t4: Book = { title: "a", author: "b", year: "1980" };',
                    expectError: true,
                    errorCode: 2322,
                  },
                  {
                    name: { en: 'A misspelt property is refused', id: 'Properti yang salah ketik ditolak' },
                    probe: 'const t5: Book = { title: "a", author: "b", year: 1, sld: 5 };',
                    expectError: true,
                    errorCode: 2561,
                  },
                ],
              ...
              hints: [
                { en: 'Each property on its own line: `name: type;`.', id: 'Tiap properti di barisnya sendiri: `nama: tipe;`.' },
                { en: 'Only `sold` gets the question mark.', id: 'Hanya `terjual` yang mendapat tanda tanya.' },
                { en: 'The separator in the summary is an em dash with spaces: `${b.title} — ${b.author} (${b.year})`.', id: 'Pemisah di ringkasannya adalah tanda pisah dengan spasi: `${b.judul} — ${b.penulis} (${b.tahun})`.' },
              ],
              solution: {
                en:
                  'interface Book {\n' +
          ...
          steps: [
            {
              ...
              code: {
                en:
                  ...
                  'const names: string[] = ["Ani", "Budi"];\n\n' +
                  'scores.push("100");   // rejected\n' +
                  'scores[0].toFixed(1); // fine: the element is a number',
                id:
            ...
            },
            {
              ...
              code: {
                en:
                  ...
                  'const wrong: Point = [0, 0, 0];   // the length does not match\n\n' +
                  'type Entry = [string, number];    // each position has its own type\n' +
                  'const e: Entry = ["stock", 12];',
                id:
            ...
            },
            {
              ...
              code: {
                en: 'type Point = [number, number];\n\nconst a: Point = [1, 2];\nconst b: Point = [1, 2, 3];\nconst c: number[] = [1, 2, 3];',
                id: 'type Titik = [number, number];\n\nconst a: Titik = [1, 2];\nconst b: Titik = [1, 2, 3];\nconst c: number[] = [1, 2, 3];',
              },
              options: [
            ...
            },
            {
              ...
              id: 't1',
              prompt: {
                en: 'Declare `type Point = [number, number]`, then write `distance(a: Point, b: Point): number` for the straight-line distance, and `pathLength(points: Point[]): number` for the total length of a path through the points in order.',
                ...
                en: [
                  {
                    ...
                    check:
                      'assert(distance([0, 0], [3, 4]) === 5, "distance([0,0],[3,4]) should be 5, got: " + distance([0, 0], [3, 4]));\n' +
                      'assert(distance([1, 1], [1, 1]) === 0, "distance of the same point should be 0, got: " + distance([1, 1], [1, 1]));\n' +
                      'assert(distance([2, 0], [0, 0]) === 2, "distance([2,0],[0,0]) should be 2, got: " + distance([2, 0], [0, 0]));',
                  },
                  {
                    name: { en: 'The path adds up its legs', id: 'Jalurnya menjumlahkan ruas-ruasnya' },
                    check:
                      'assert(pathLength([[0, 0], [3, 4], [3, 0]]) === 9, "should be 9, got: " + pathLength([[0, 0], [3, 4], [3, 0]]));\n' +
                      'assert(pathLength([[0, 0]]) === 0, "a single point should be 0, got: " + pathLength([[0, 0]]));\n' +
                      'assert(pathLength([]) === 0, "an empty path should be 0, got: " + pathLength([]));',
                  },
                  {
                    name: { en: 'A point is exactly two numbers', id: 'Satu titik tepat dua angka' },
                    probe: 'const t1: Point = [1, 2];',
                  },
                  {
                    name: { en: 'Three numbers are not a point', id: 'Tiga angka bukan sebuah titik' },
                    probe: 'const t2: Point = [1, 2, 3];',
                    expectError: true,
                  },
                  {
                    name: { en: 'One number is not a point either', id: 'Satu angka juga bukan sebuah titik' },
                    probe: 'const t3: Point = [1];',
                    expectError: true,
                  },
                  {
                    name: { en: 'A path is a list of points', id: 'Jalur adalah daftar titik' },
                    probe: 'const t4 = pathLength([[0, 0], [1, 1]]);',
                  },
                  {
                    name: { en: 'A list of numbers is not a path', id: 'Daftar angka bukan sebuah jalur' },
                    probe: 'pathLength([0, 0, 1, 1]);',
                    expectError: true,
                    errorCode: 2322,
                  },
                ],
      ...
      project: {
        ...
        requirements: [
          { en: '`interface Product` has `name` (string), `price` (number), `stock` (number), and an optional `discount` (number, a percentage).', id: '`interface Produk` punya `nama` (string), `harga` (number), `stok` (number), dan `diskon` opsional (number, berupa persen).' },
          { en: '`sellPrice(p)` returns the price after the discount, rounded down. No discount means the full price.', id: '`hargaJual(p)` mengembalikan harga setelah diskon, dibulatkan ke bawah. Tanpa diskon berarti harga penuh.' },
          { en: '`available(list)` returns only the products with stock above zero, in the order given.', id: '`tersedia(daftar)` mengembalikan hanya produk yang stoknya di atas nol, dalam urutan yang diberikan.' },
          { en: '`totalValue(list)` returns the sum of `sellPrice` × `stock` over the whole list.', id: '`totalNilai(daftar)` mengembalikan jumlah `hargaJual` × `stok` untuk seluruh daftarnya.' },
          { en: 'Annotate everything. Nothing may be `any`.', id: 'Beri keterangan pada semuanya. Tak boleh ada yang `any`.' },
        ],
        starter: {
          en:
            'interface Product {\n\n}\n\n' +
            'function sellPrice(p: Product): number {\n\n}\n\n' +
            'function available(list: Product[]): Product[] {\n\n}\n\n' +
            'function totalValue(list: Product[]): number {\n\n}\n',
          id:
            'interface Produk {\n\n}\n\n' +
          ...
          en: [
            {
              ...
              check:
                'assert(sellPrice({ name: "a", price: 100000, stock: 1, discount: 10 }) === 90000, "10% discount off 100000 should be 90000");\n' +
                'assert(sellPrice({ name: "a", price: 9999, stock: 1, discount: 33 }) === 6699, "should round down, got: " + sellPrice({ name: "a", price: 9999, stock: 1, discount: 33 }));',
            },
            {
              name: { en: 'No discount means the full price', id: 'Tanpa diskon berarti harga penuh' },
              check:
                'assert(sellPrice({ name: "a", price: 100000, stock: 1 }) === 100000, "with no discount should be 100000, got: " + sellPrice({ name: "a", price: 100000, stock: 1 }));',
            },
            {
              name: { en: 'Only what is in stock comes back', id: 'Hanya yang tersedia yang kembali' },
              check:
                'const list = [\n' +
                '  { name: "Pencil", price: 3000, stock: 40 },\n' +
                '  { name: "Marker", price: 12000, stock: 0 },\n' +
                '  { name: "Folder", price: 4000, stock: 25 },\n' +
                '];\n' +
                'const inStock = available(list);\n' +
                'assert(inStock.length === 2, "should be 2 products, got: " + inStock.length);\n' +
                'assert(inStock[0].name === "Pencil" && inStock[1].name === "Folder", "the order should be kept, got: " + inStock.map((p) => p.name).join(", "));\n' +
                'assert(list.length === 3, "the original list must not be changed, length is now: " + list.length);',
            },
            {
              ...
              check:
                'const list = [\n' +
                '  { name: "Pencil", price: 3000, stock: 40 },\n' +
                '  { name: "Book", price: 5000, stock: 10, discount: 20 },\n' +
                '  { name: "Marker", price: 12000, stock: 0 },\n' +
                '];\n' +
                'assert(totalValue(list) === 160000, "40*3000 + 10*4000 + 0 = 160000, got: " + totalValue(list));\n' +
                'assert(totalValue([]) === 0, "an empty list should be 0, got: " + totalValue([]));',
            },
            {
              name: { en: 'A complete product is accepted', id: 'Produk yang lengkap diterima' },
              probe: 'const t1: Product = { name: "a", price: 1, stock: 2, discount: 3 };',
            },
            {
              name: { en: 'discount may be left out', id: 'diskon boleh tidak ada' },
              probe: 'const t2: Product = { name: "a", price: 1, stock: 2 };',
            },
            {
              name: { en: 'A missing stock is refused', id: 'stok yang hilang ditolak' },
              probe: 'const t3: Product = { name: "a", price: 1 };',
              expectError: true,
              errorCode: 2741,
            },
            {
              name: { en: 'A price written as text is refused', id: 'Harga yang ditulis sebagai teks ditolak' },
              probe: 'const t4: Product = { name: "a", price: "1", stock: 2 };',
              expectError: true,
              errorCode: 2322,
            },
            {
              name: { en: 'available gives back products, not names', id: 'tersedia mengembalikan produk, bukan nama' },
              probe: 'const t5: string[] = available([{ name: "a", price: 1, stock: 2 }]);',
              expectError: true,
              errorCode: 2322,
            },
            {
              name: { en: 'totalValue wants a list, not one product', id: 'totalNilai meminta daftar, bukan satu produk' },
              probe: 'totalValue({ name: "a", price: 1, stock: 2 });',
              expectError: true,
              errorCode: 2353,
            },
          ],
        ...
        hints: [
          { en: 'Write the interface first. Every function below already says it takes a Product, so the shape is the only thing missing.', id: 'Tulis interface-nya lebih dulu. Tiap fungsi di bawahnya sudah menyatakan menerima Produk, jadi bentuknya satu-satunya yang kurang.' },
          { en: 'An optional discount is `undefined` when absent, so give it a floor: `p.discount ?? 0`.', id: 'Diskon opsional bernilai `undefined` saat tak ada, jadi beri ia lantai: `p.diskon ?? 0`.' },
          ...
          { en: 'The total is built from sellPrice, not from price: the discount has to be in it.', id: 'Totalnya dibangun dari hargaJual, bukan dari harga: diskonnya harus ikut di dalamnya.' },
        ],
        solution: {
          en:
            'interface Product {\n' +
            ...
            '  return Math.floor(p.price - (p.price * discount) / 100);\n' +
            '}\n\n' +
            'function available(list: Product[]): Product[] {\n' +
            '  return list.filter((p) => p.stock > 0);\n' +
            '}\n\n' +
            'function totalValue(list: Product[]): number {\n' +
            '  return list.reduce((sum, p) => sum + sellPrice(p) * p.stock, 0);\n' +
            '}',
          id:
            'interface Produk {\n' +
            '  nama: string;\n' +
