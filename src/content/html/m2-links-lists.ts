          ...
          steps: [
            ...
            },
            {
              ...
              figure: {
                ...
                ySpan: [0, 14],
                items: [
                  { t: 'poly', pts: [[5.7, 11.6], [8.3, 11.6], [8.3, 12.8], [5.7, 12.8]], color: 'muted', label: 'ul' },
                  { t: 'poly', pts: [[1.7, 8.6], [4.3, 8.6], [4.3, 9.8], [1.7, 9.8]], color: 'a', label: 'li' },
                  { t: 'poly', pts: [[9.7, 8.6], [12.3, 8.6], [12.3, 9.8], [9.7, 9.8]], color: 'a', label: 'li' },
                  { t: 'poly', pts: [[1.7, 5.6], [4.3, 5.6], [4.3, 6.8], [1.7, 6.8]], color: 'muted', label: 'ul' },
                  { t: 'poly', pts: [[0.2, 2.6], [2.4, 2.6], [2.4, 3.8], [0.2, 3.8]], color: 'a', label: 'li' },
                  { t: 'poly', pts: [[3.6, 2.6], [5.8, 2.6], [5.8, 3.8], [3.6, 3.8]], color: 'a', label: 'li' },
                  { t: 'seg', from: [7, 11.6], to: [3, 9.8], color: 'muted' },
                  { t: 'seg', from: [7, 11.6], to: [11, 9.8], color: 'muted' },
                  { t: 'seg', from: [3, 8.6], to: [3, 6.8], color: 'muted' },
                  { t: 'seg', from: [3, 5.6], to: [1.3, 3.8], color: 'muted' },
                  { t: 'seg', from: [3, 5.6], to: [4.7, 3.8], color: 'muted' },
                ],
                caption: {
                  en: 'The inner `<ul>` sits inside the `<li>` that starts the outer list\'s first item — nested one level deeper, not squeezed between two `<li>` elements.',
                  id: '`<ul>` bagian dalam berada di dalam `<li>` yang memulai item pertama daftar luarnya — bersarang satu tingkat lebih dalam, bukan diselipkan di antara dua elemen `<li>`.',
                },
              },
              code: {
                en: '<ul>\n  <li>Fruit\n    <ul>\n      <li>Apple</li>\n      <li>Mango</li>\n    </ul>\n  </li>\n  <li>Vegetable</li>\n</ul>',
