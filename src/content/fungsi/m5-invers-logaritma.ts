          ...
          steps: [
            {
              ...
              figure: {
                ...
                ySpan: [-2, 8],
                ticks: true,
                params: [{ name: 'c', min: 0, max: 7, step: 0.25, value: 4, label: 'y = c' }],
                items: [
                  { t: 'curve', f: 'x^2', color: 'muted', dashed: true, label: 'x² pada R' },
                  { t: 'curve', f: 'x^2', from: 0, color: 'a', label: 'x² pada [0, ∞)' },
                  { t: 'hline', y: 'c', color: 'b' },
                  { t: 'dot', x: '-sqrt(c)', y: 'c', open: true, color: 'b' },
                  { t: 'dot', x: 'sqrt(c)', y: 'c', color: 'b' },
                ],
                caption: {
                  en: 'Move the line $y = c$. On the full parabola it always meets twice — the test fails. Keep only the solid right half and it meets that once, for every $c \\geq 0$ — and now there is an inverse.',
                  id: 'Geser garis $y = c$. Pada parabola utuhnya ia selalu memotong dua kali — ujinya gagal. Sisakan hanya belahan kanan yang digambar penuh dan ia memotongnya sekali, untuk setiap $c \\geq 0$ — dan kini inversnya ada.',
                },
              },
            },
            {
          ...
          steps: [
            ...
            },
            {
              ...
              figure: {
                ...
                ticks: true,
                params: [
                  { name: 'm', min: 0.5, max: 3, step: 0.25, value: 2 },
                  { name: 'b', min: -3, max: 3, step: 0.5, value: 3 },
                ],
                items: [
                  { t: 'curve', f: 'm*x+b', color: 'a', label: 'mx + b' },
                  { t: 'curve', f: '(x-b)/m', color: 'b', label: '(x−b)/m' },
                  { t: 'curve', f: 'x', color: 'muted', dashed: true, label: 'y = x' },
                  { t: 'dot', x: 0, y: 'b', color: 'a' },
                  { t: 'dot', x: 'b', y: 0, color: 'b' },
                ],
                caption: {
                  en: 'Move $m$ and $b$. Fold the page along the dashed diagonal and the two lines always swap places, whatever they are — the marked points $(0, b)$ and $(b, 0)$ are the same point, seen from each side.',
                  id: 'Geser $m$ dan $b$. Lipat kertasnya sepanjang diagonal putus-putus dan kedua garisnya selalu bertukar tempat, apa pun nilainya — titik yang ditandai $(0, b)$ dan $(b, 0)$ adalah titik yang sama, dilihat dari masing-masing sisi.',
                },
              },
            },
            {
          ...
          steps: [
            {
              ...
              figure: {
                ...
                caption: {
                  en: 'Move the base $a$. The same curve twice, folded across the diagonal, for every base. The horizontal asymptote of one is the vertical asymptote of the other, and the two marked points are each other reversed — always $(0,1)$ and $(1,0)$, since $a^0 = 1$ and $\\log_a 1 = 0$ no matter what $a$ is.',
                  id: 'Geser basis $a$. Kurva yang sama, dua kali, dilipat pada diagonalnya, untuk basis apa pun. Asimtot mendatar yang satu menjadi asimtot tegak yang lain, dan kedua titik yang ditandai adalah kebalikan satu sama lain — selalu $(0,1)$ dan $(1,0)$, sebab $a^0 = 1$ dan $\\log_a 1 = 0$ apa pun nilai $a$.',
                },
              },
            },
            {
