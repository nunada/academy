          ...
          steps: [
            {
              ...
              figure: {
                ...
                ySpan: [0, 9000],
                ticks: true,
                params: [{ name: 't', min: 1, max: 6, step: 0.5, value: 3, label: 'T' }],
                items: [
                  { t: 'curve', f: '500*2^(x/t)', from: 0, color: 'a', label: 'eksponen' },
                  { t: 'curve', f: '500+700*x', from: 0, color: 'muted', dashed: true, label: 'linear' },
                  { t: 'dot', x: 't', y: 1000 },
                  { t: 'dot', x: '2*t', y: 2000 },
                  { t: 'dot', x: '3*t', y: 4000 },
                  { t: 'dot', x: '4*t', y: 8000, label: '8000' },
                ],
                caption: {
                  en: '500 bacteria doubling every $T$ hours. Move $T$ and the marked points $1000, 2000, 4000, 8000$ slide sideways, but each one is still always twice the one before it. The dashed line adds a fixed 700 an hour and is left far behind.',
                  id: '500 bakteri yang berlipat dua tiap $T$ jam. Geser $T$ dan titik-titik yang ditandai $1000, 2000, 4000, 8000$ bergeser mendatar, tetapi tiap titik selalu tetap dua kali yang sebelumnya. Garis putus-putus menambah 700 tiap jam dan tertinggal jauh.',
                },
              },
            },
            {
          ...
          steps: [
            {
              ...
              figure: {
                ...
                ySpan: [900, 3400],
                ticks: true,
                params: [{ name: 'n', min: 1, max: 365, step: 1, value: 12, label: 'n' }],
                items: [
                  { t: 'curve', f: '1000*(1+0.06/n)^(n*x)', from: 0, color: 'a', label: 'n kali/tahun' },
                ...
                caption: {
                  en: '1000 at 6% for twenty years, compounded $n$ times a year. Push $n$ up and the solid curve hugs the dashed continuous one ever more closely — it never crosses it, only gets closer. Simple interest, never compounded at all, is the straight line far below.',
                  id: '1000 dengan bunga 6% selama dua puluh tahun, dimajemukkan $n$ kali setahun. Naikkan $n$ dan kurva penuhnya makin merapat pada kurva sinambung yang putus-putus — tak pernah melewatinya, hanya makin dekat. Bunga tunggal, yang sama sekali tak pernah dimajemukkan, adalah garis lurus jauh di bawahnya.',
                },
              },
            },
            {
          ...
          steps: [
            {
              ...
              figure: {
                ...
                ySpan: [0, 90],
                ticks: true,
                params: [{ name: 't', min: 2, max: 12, step: 1, value: 6, label: 'T' }],
                items: [
                  { t: 'curve', f: '80*0.5^(x/t)', from: 0, color: 'a', label: 'peluruhan' },
                  { t: 'dot', x: 't', y: 40, label: '40' },
                  { t: 'dot', x: '2*t', y: 20, label: '20' },
                  { t: 'dot', x: '3*t', y: 10, label: '10' },
                  { t: 'hline', y: 0 },
                ],
                caption: {
                  en: 'Every $T$ hours, whatever is left is halved. Move $T$ and the marked points slide sideways, but each one is still always half of the one before — the curve never reaches the axis, there is always something left.',
                  id: 'Tiap $T$ jam, apa pun yang tersisa dibagi dua. Geser $T$ dan titik-titik yang ditandai bergeser mendatar, tetapi tiap titik selalu tetap separuh dari sebelumnya — kurvanya tak pernah mencapai sumbu, selalu ada yang tersisa.',
                },
              },
            },
            {
