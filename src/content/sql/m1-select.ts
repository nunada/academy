...
const SCHEMA = `CREATE TABLE buku (
  ...
  submodules: [
    {
      ...
      lessons: [
        {
          ...
          steps: [
            ...
            },
            {
              ...
              code: 'SELECT judul, harga FROM buku;',
              output:
                'judul            harga\n' +
            ...
            },
            {
              ...
              code: 'SELECT judul AS nama, tahun AS terbit FROM buku;',
              output:
                'nama             terbit\n' +
                'Laskar Pelangi   2005\n' +
                'Bumi Manusia     1980\n' +
            ...
            },
            {
              ...
              id: 'f1',
              prompt: {
                en: 'Complete the query that returns the author and the year, with the author labelled `oleh`.',
                id: 'Lengkapi kueri yang mengembalikan penulis dan tahun, dengan penulis dilabeli `oleh`.',
              },
              template: 'SELECT penulis ___ oleh, tahun ___ buku;',
              blanks: ['AS', 'FROM'],
              explain: {
            ...
            },
            {
              ...
              schema: SCHEMA,
              prompt: {
                en: 'Return two columns from `buku`: the title labelled `nama`, and the year. Nothing else.',
                id: 'Kembalikan dua kolom dari `buku`: judulnya dilabeli `nama`, dan tahunnya. Tidak ada yang lain.',
              },
              starter: 'SELECT * FROM buku;\n',
              tests: [
                {
              ...
              hints: [
                ...
                { en: 'Only `judul` needs renaming; `tahun` is already right.', id: 'Hanya `judul` yang perlu diganti namanya; `tahun` sudah benar.' },
                { en: 'SELECT judul AS nama, ... FROM buku;', id: 'SELECT judul AS nama, ... FROM buku;' },
              ],
              solution: 'SELECT judul AS nama, tahun FROM buku;',
            },
          ],
        },
        {
          ...
          steps: [
            {
              ...
              code: 'SELECT judul, stok FROM buku WHERE stok = 0;',
              output: 'judul          stok\nPerahu Kertas  0\nPulang         0',
            },
            {
              kind: 'concept',
            ...
            },
            {
              ...
              code: 'SELECT judul FROM buku WHERE harga < 100000 AND stok > 5;',
              options: [
            ...
            },
            {
              ...
              lines: ['SELECT judul, penulis', 'FROM buku', "WHERE penulis = 'Eka Kurniawan'", 'ORDER BY judul;'],
              explain: {
            ...
            },
            {
              ...
              schema: SCHEMA,
              prompt: {
                en: 'Return `judul` and `stok` for the books that are actually in stock — stock above zero.',
                id: 'Kembalikan `judul` dan `stok` untuk buku yang benar-benar tersedia — stok di atas nol.',
              },
              starter: 'SELECT judul, stok FROM buku;\n',
              tests: [
                {
              ...
              hints: [
                ...
                { en: 'SELECT judul, stok FROM buku WHERE stok > 0;', id: 'SELECT judul, stok FROM buku WHERE stok > 0;' },
              ],
              solution: 'SELECT judul, stok FROM buku WHERE stok > 0;',
            },
          ],
        },
      ],
      project: {
        ...
        requirements: [
          { en: 'Return exactly two columns: the title labelled `buku`, and `harga`.', id: 'Kembalikan tepat dua kolom: judulnya dilabeli `buku`, dan `harga`.' },
        ...
        starter: 'SELECT judul, harga FROM buku;\n',
        tests: [
          {
        ...
        hints: [
          ...
          { en: 'Rename with AS in the SELECT list: judul AS buku.', id: 'Ganti nama dengan AS di daftar SELECT: judul AS buku.' },
        ],
        solution: 'SELECT judul AS buku, harga\nFROM buku\nWHERE harga <= 100000\n  AND stok > 0;',
        xp: 50,
      },
    },
    {
          ...
          steps: [
            {
              ...
              code: 'SELECT judul, harga FROM buku ORDER BY harga;',
              output:
                'judul            harga\n' +
                'Perahu Kertas    78000\n' +
                'Laskar Pelangi   85000\n' +
            ...
            },
            {
              ...
              code: 'SELECT judul, tahun FROM buku ORDER BY tahun DESC, judul;',
            },
            {
              kind: 'concept',
              id: 'c3',
              ...
              code: 'SELECT judul, harga FROM buku ORDER BY harga DESC LIMIT 2;',
              output: 'judul            harga\nCantik Itu Luka  125000\nBumi Manusia     110000',
            },
            {
              kind: 'quiz',
              ...
              code: 'SELECT judul FROM buku LIMIT 3;',
              options: [
            ...
            },
            {
              ...
              template: 'SELECT judul FROM buku ORDER BY tahun ___ ___ 3;',
              blanks: ['DESC', 'LIMIT'],
              explain: {
            ...
            },
            {
              ...
              schema: SCHEMA,
              prompt: {
                en: 'Return `judul` and `harga` for the three most expensive books, most expensive first.',
              ...
              hints: [
                ...
                { en: 'ORDER BY harga DESC LIMIT 3', id: 'ORDER BY harga DESC LIMIT 3' },
              ],
              solution: 'SELECT judul, harga\nFROM buku\nORDER BY harga DESC\nLIMIT 3;',
            },
          ],
        },
        {
          ...
          steps: [
            ...
            },
            {
              ...
              code: "SELECT judul FROM buku WHERE judul LIKE 'P%';",
              output: 'judul\nPerahu Kertas\nPulang',
            },
            {
              kind: 'quiz',
              ...
              code: "SELECT judul FROM buku WHERE judul LIKE '%a%';",
              options: [
            ...
            },
            {
              ...
              lines: ['SELECT judul, harga', 'FROM buku', "WHERE penulis LIKE 'D%'", 'ORDER BY harga;'],
              explain: {
            ...
            },
            {
              ...
              schema: SCHEMA,
              prompt: {
                en: 'Return `judul` and `penulis` for books whose author\'s name **starts with** the letter A.',
                id: 'Kembalikan `judul` dan `penulis` untuk buku yang nama penulisnya **diawali** huruf A.',
              },
              starter: "SELECT judul, penulis FROM buku WHERE penulis = 'A';\n",
              tests: [
                {
              ...
              hints: [
                ...
                { en: "WHERE penulis LIKE 'A%'", id: "WHERE penulis LIKE 'A%'" },
              ],
              solution: "SELECT judul, penulis\nFROM buku\nWHERE penulis LIKE 'A%';",
            },
          ],
        },
      ],
      project: {
        ...
        requirements: [
          { en: 'Return three columns: the title labelled `buku`, then `harga` and `stok`.', id: 'Kembalikan tiga kolom: judulnya dilabeli `buku`, lalu `harga` dan `stok`.' },
        ...
        starter: 'SELECT judul, harga, stok FROM buku;\n',
        tests: [
          {
