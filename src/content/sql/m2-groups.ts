          ...
          steps: [
            {
              ...
              figure: {
                ...
                height: 260,
                items: [
                  { t: 'poly', pts: [[0.5, 8.3], [4.5, 8.3], [4.5, 9.7], [0.5, 9.7]], color: 'a' },
                  { t: 'poly', pts: [[0.5, 6.3], [4.5, 6.3], [4.5, 7.7], [0.5, 7.7]], color: 'a' },
                  { t: 'poly', pts: [[0.5, 4.3], [4.5, 4.3], [4.5, 5.7], [0.5, 5.7]], color: 'a' },
                  { t: 'poly', pts: [[0.5, 2.3], [4.5, 2.3], [4.5, 3.7], [0.5, 3.7]], color: 'a' },
                  { t: 'poly', pts: [[0.5, 0.3], [4.5, 0.3], [4.5, 1.7], [0.5, 1.7]], color: 'a' },
                  { t: 'vec', from: [4.5, 9], to: [9, 5], color: 'a' },
                  { t: 'vec', from: [4.5, 7], to: [9, 5], color: 'a' },
                  { t: 'vec', from: [4.5, 5], to: [9, 5], color: 'a' },
                  { t: 'vec', from: [4.5, 3], to: [9, 5], color: 'a' },
                  { t: 'vec', from: [4.5, 1], to: [9, 5], color: 'a' },
                  { t: 'poly', pts: [[9, 3.5], [13.5, 3.5], [13.5, 6.5], [9, 6.5]], color: 'result', label: 'COUNT · SUM · MAX' },
                ],
                caption: {
                  en: 'Every row in the table feeds into the same aggregate — the rows go in, and exactly one row of results comes out.',
                  id: 'Tiap baris di tabel masuk ke agregat yang sama — barisnya masuk, dan tepat satu baris hasil yang keluar.',
                },
              },
              code: {
          ...
          steps: [
            {
              ...
              figure: {
                ...
                height: 300,
                items: [
                  { t: 'poly', pts: [[0, 0], [5, 0], [5, 10], [0, 10]], color: 'a', label: 'Bandung', labelAt: [2.5, 9.3] },
                  { t: 'poly', pts: [[6, 0], [11, 0], [11, 10], [6, 10]], color: 'b', label: 'Jakarta', labelAt: [8.5, 9.3] },
                  { t: 'poly', pts: [[12, 0], [17, 0], [17, 10], [12, 10]], color: 'c', label: 'Surabaya', labelAt: [14.5, 9.3] },
                  { t: 'poly', pts: [[0.3, 4.9], [4.7, 4.9], [4.7, 8.2], [0.3, 8.2]], color: 'muted' },
                  { t: 'poly', pts: [[0.3, 0.8], [4.7, 0.8], [4.7, 4.1], [0.3, 4.1]], color: 'muted' },
                  { t: 'poly', pts: [[6.3, 4.9], [10.7, 4.9], [10.7, 8.2], [6.3, 8.2]], color: 'muted' },
                  { t: 'poly', pts: [[6.3, 0.8], [10.7, 0.8], [10.7, 4.1], [6.3, 4.1]], color: 'muted' },
                  { t: 'poly', pts: [[12.3, 6.4], [16.7, 6.4], [16.7, 7.9], [12.3, 7.9]], color: 'muted' },
                  { t: 'poly', pts: [[12.3, 4.7], [16.7, 4.7], [16.7, 6.2], [12.3, 6.2]], color: 'muted' },
                  { t: 'poly', pts: [[12.3, 3.0], [16.7, 3.0], [16.7, 4.5], [12.3, 4.5]], color: 'muted' },
                  { t: 'poly', pts: [[12.3, 0.8], [16.7, 0.8], [16.7, 2.3], [12.3, 2.3]], color: 'muted' },
                  { t: 'vec', from: [5, 5], to: [19, 8.5], color: 'a' },
                  { t: 'vec', from: [11, 5], to: [19, 5], color: 'b' },
                  { t: 'vec', from: [17, 5], to: [19, 1.5], color: 'c' },
                  { t: 'poly', pts: [[19, 7.5], [24, 7.5], [24, 9.5], [19, 9.5]], color: 'result', label: 'Bandung (2)' },
                  { t: 'poly', pts: [[19, 4], [24, 4], [24, 6], [19, 6]], color: 'result', label: 'Jakarta (2)' },
                  { t: 'poly', pts: [[19, 0.5], [24, 0.5], [24, 2.5], [19, 2.5]], color: 'result', label: 'Surabaya (4)' },
                ],
                caption: {
                  en: 'Every order row is sorted into the bucket for its city; each bucket then collapses to exactly one output row.',
                  id: 'Tiap baris pesanan dipilah ke ember kotanya; tiap ember lalu meringkas jadi tepat satu baris keluaran.',
                },
              },
              code: {
