            ...
            },
            {
              ...
              figure: {
                ...
                items: [
                  ...
                  { t: 'curve', f: 'x0^2+2*x0*(x-x0)', color: 'b', dashed: true, label: 'tangent' },
                  { t: 'dot', x: 'x0', y: 'x0^2', color: 'b', label: 'P' },
                  { t: 'dot', x: 'x0', y: '2*x0', color: 'result', label: "f'(x₀)" },
                ],
                caption: {
                  en: 'Move $x_0$: the dashed tangent at $P=(x_0,x_0^2)$ always has slope matching the height of the second graph directly below it — the line and the point read the same number two different ways.',
                  id: 'Geser $x_0$: garis singgung putus-putus di $P=(x_0,x_0^2)$ selalu punya kemiringan yang cocok dengan tinggi grafik kedua tepat di bawahnya — garis dan titiknya membaca bilangan yang sama dengan dua cara.',
                },
              },
            },
            {
          ...
          steps: [
            ...
            },
            {
              ...
              figure: {
                ...
                ySpan: [-1, 4],
                ticks: true,
                params: [{ name: 'h', min: -2, max: 2, step: 0.1, value: 1.5 }],
                items: [
                  { t: 'curve', f: 'abs(x)', color: 'a' },
                  { t: 'point', at: [0, 0], label: 'sudut' },
                  { t: 'curve', f: 'sign(h)*x', color: 'b', dashed: true, label: 'secant' },
                  { t: 'dot', x: 'h', y: 'abs(h)', color: 'b', label: 'Q' },
                ],
                caption: {
                  en: 'Drag $h$ through $0$: the secant from the corner to $Q=(h,|h|)$ does not swing smoothly — it snaps from slope $-1$ to slope $1$ the instant $h$ crosses zero, which is exactly why no single tangent exists there.',
                  id: 'Geser $h$ melewati $0$: tali busur dari sudut ke $Q=(h,|h|)$ tidak berputar mulus — ia melompat dari kemiringan $-1$ ke kemiringan $1$ persis saat $h$ melewati nol, dan itulah sebabnya tak ada satu garis singgung pun di situ.',
                },
              },
            },
            {
