          ...
          steps: [
            ...
            },
            {
              ...
              figure: {
                ...
                items: [
                  { t: 'curve', f: 'x^2', color: 'a' },
                  { t: 'point', at: [2, 4], label: 'A' },
                  { t: 'seg', from: [0.5, 0.25], to: [3.5, 12.25], color: 'muted', dashed: true },
                  { t: 'seg', from: [1.2, 1.44], to: [2.8, 7.84], color: 'muted', dashed: true },
                  { t: 'seg', from: [0.5, -2], to: [3.5, 14], color: 'b' },
                ],
                caption: {
                  en: 'Two faint secants through nearby points, and the solid line they are converging toward — the tangent at $A(2,4)$, slope $4$.',
                  id: 'Dua tali busur samar melalui titik-titik dekat, dan garis penuh yang mereka dekati — garis singgung di $A(2,4)$, dengan kemiringan $4$.',
                },
              },
            },
            {
