            ...
            },
            {
              ...
              figure: {
                ...
                items: [
                  ...
                  { t: 'dot', x: 'x0', y: 'sin(x0)', color: 'b', label: 'A' },
                ],
                caption: {
                  en: 'Move $x_0$ along the sine wave: the tangent slope at $A$ always equals $\\cos(x_0)$ — steepest where the curve crosses the axis, flat right at each crest and trough.',
                  id: 'Geser $x_0$ sepanjang gelombang sinus: kemiringan garis singgung di $A$ selalu sama dengan $\\cos(x_0)$ — paling curam saat kurvanya memotong sumbu, datar tepat di tiap puncak dan lembah.',
                },
              },
            },
            {
            ...
            },
            {
              ...
              figure: {
                ...
                items: [
                  ...
                  { t: 'dot', x: 'x0', y: 'e^x0', color: 'b', label: 'A' },
                ],
                caption: {
                  en: 'Move $x_0$: the tangent slope at $A$ always equals the height of the curve there — height and slope agree everywhere, which is the whole content of $\\frac{d}{dx}(e^x)=e^x$.',
                  id: 'Geser $x_0$: kemiringan garis singgung di $A$ selalu sama dengan tinggi kurvanya di situ — tinggi dan kemiringan sepakat di mana-mana, dan itulah seluruh isi $\\frac{d}{dx}(e^x)=e^x$.',
                },
              },
            },
            {
          ...
          steps: [
            {
              ...
              figure: {
                ...
                items: [
                  ...
                  { t: 'dot', x: 'x0', y: 'ln(x0)', color: 'b', label: 'A' },
                ],
                caption: {
                  en: 'Move $x_0$: the tangent slope at $A$ always equals $\\frac{1}{x_0}$ — steep near $0$, and visibly flattening further right as $\\frac1x$ shrinks.',
                  id: 'Geser $x_0$: kemiringan garis singgung di $A$ selalu sama dengan $\\frac{1}{x_0}$ — curam dekat $0$, dan tampak memipih lebih ke kanan seiring $\\frac1x$ menyusut.',
                },
              },
            },
            {
            ...
            },
            {
              ...
              figure: {
                ...
                items: [
                  ...
                  { t: 'dot', x: 'x0', y: 'x0^x0', color: 'b', label: 'A' },
                ],
                caption: {
                  en: 'Move $x_0$: the tangent slope at $A$ always equals $x_0^{x_0}(\\ln x_0+1)$ — a fact ordinary differentiation rules cannot reach directly, since $x$ appears in both the base and the exponent.',
                  id: 'Geser $x_0$: kemiringan garis singgung di $A$ selalu sama dengan $x_0^{x_0}(\\ln x_0+1)$ — fakta yang tak bisa dicapai aturan turunan biasa secara langsung, sebab $x$ muncul baik di basis maupun di pangkat.',
                },
              },
            },
            {
          ...
          steps: [
            {
              ...
              figure: {
                ...
                items: [
                  ...
                  { t: 'dot', x: 'x0', y: 'asin(x0)', color: 'b', label: 'A' },
                ],
                caption: {
                  en: 'Move $x_0$ toward $\\pm 1$: the tangent at $A$ gets steeper and steeper, matching how $1/\\sqrt{1-x_0^2}$ blows up as $x_0$ approaches the domain\'s edge.',
                  id: 'Geser $x_0$ menuju $\\pm 1$: garis singgung di $A$ makin curam, cocok dengan $1/\\sqrt{1-x_0^2}$ yang membesar tak terhingga saat $x_0$ mendekati tepi domainnya.',
                },
              },
            },
            {
          ...
          steps: [
            {
              ...
              figure: {
                ...
                items: [
                  ...
                  { t: 'dot', x: 'x0', y: 'atan(x0)', color: 'b', label: 'A' },
                ],
                caption: {
                  en: 'Move $x_0$ far from the origin in either direction: the tangent at $A$ keeps flattening, matching how $\\frac{1}{1+x_0^2}$ shrinks toward $0$ — yet, unlike $\\arcsin x$, it never becomes undefined, since $x$ can range over all of $ℝ$.',
                  id: 'Geser $x_0$ menjauh dari titik asal ke arah mana pun: garis singgung di $A$ terus memipih, cocok dengan $\\frac{1}{1+x_0^2}$ yang menyusut menuju $0$ — namun, tak seperti $\\arcsin x$, ia tak pernah menjadi tak terdefinisi, sebab $x$ bisa berkisar di seluruh $ℝ$.',
                },
              },
            },
            {
