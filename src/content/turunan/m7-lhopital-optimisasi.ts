        ...
        },
        {
          ...
          steps: [
            ...
            },
            {
              ...
              body: {
                en: 'By $x_3\\approx 1.41422$, already four decimal digits agree with $\\sqrt{2}\\approx 1.41421356$ — this rapid, roughly digit-doubling convergence is typical of Newton\'s Method near a root where $f\'\\neq 0$. It is not infallible, though:\n\n- If $f\'(x_n)=0$ at some step, the formula divides by zero and breaks down entirely.\n- A poorly chosen starting guess can send the iteration far from the intended root, or toward a different one altogether.\n\nThe method trades the certainty of an exact algebraic formula for speed — and needs a reasonable starting guess to pay off.',
                id: 'Pada $x_3\\approx 1.41422$, sudah empat digit desimal yang cocok dengan $\\sqrt{2}\\approx 1.41421356$ — konvergensi yang cepat, kurang lebih menggandakan digit ini khas Metode Newton di dekat akar tempat $f\'\\neq 0$. Meski begitu, tak selalu berhasil:\n\n- Jika $f\'(x_n)=0$ pada suatu langkah, rumusnya membagi dengan nol dan gagal sepenuhnya.\n- Tebakan awal yang dipilih dengan buruk bisa mengirim iterasinya jauh dari akar yang dituju, atau menuju akar yang sama sekali berbeda.\n\nMetodenya menukar kepastian rumus aljabar eksak dengan kecepatan — dan memerlukan tebakan awal yang wajar agar berhasil.',
              },
            },
            {
              kind: 'quiz',
