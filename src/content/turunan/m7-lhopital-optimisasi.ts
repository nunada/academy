          ...
          steps: [
            {
              ...
              figure: {
                ...
                caption: {
                  en: 'The tangent to $f(x) = x^2 - 2$ at the guess $x_0 = 1$ crosses the $x$-axis at $x_1 = 1.5$ — already closer to the true root, $\\sqrt{2} \\approx 1.41421$.',
                  id: 'Garis singgung $f(x) = x^2 - 2$ pada tebakan $x_0 = 1$ memotong sumbu-$x$ di $x_1 = 1.5$ — sudah lebih dekat ke akar sebenarnya, $\\sqrt{2} \\approx 1{,}41421$.',
                },
              },
            },
            {
