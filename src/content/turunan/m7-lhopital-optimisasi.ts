  ...
  submodules: [
    /* --------------------------------------------------------- 7.1 l'hopital's rule */
    {
      ...
      lessons: [
        {
          ...
          steps: [
            ...
            },
            {
              ...
              options: [
                { en: 'That the limit is actually a 0/0 or infinity/infinity indeterminate form', id: 'Bahwa limitnya sungguh bentuk tak tentu 0/0 atau tak hingga/tak hingga' },
            ...
            },
            {
              ...
              id: 'm1',
              prompt: {
                en: "Use L'Hôpital's Rule to evaluate the limit of (e^x - 1)/x as x approaches 0.",
                id: "Pakai Aturan L'Hôpital untuk menghitung limit dari (e^x - 1)/x saat x mendekati 0.",
              },
              blanks: [{ answer: 1 }],
              hints: [
              ...
              explain: {
                en: 'lim(x→0) e^x/1 = e^0 = 1.',
                id: 'lim(x→0) e^x/1 = e^0 = 1.',
              },
            },
          ],
        },
        {
          ...
          steps: [
            ...
            },
            {
              ...
              options: [
                { en: "L'Hôpital's Rule is built for quotients of the form 0/0 or infinity/infinity, not for exponents", id: "Aturan L'Hôpital dibangun untuk hasil bagi berbentuk 0/0 atau tak hingga/tak hingga, bukan untuk pangkat" },
            ...
            },
            {
              ...
              id: 'm1',
              prompt: {
                en: 'Evaluate the limit of x^2 · ln(x) as x approaches 0 from the right.',
                id: 'Hitung limit dari x^2 · ln(x) saat x mendekati 0 dari kanan.',
              },
              blanks: [{ answer: 0 }],
              hints: [
                { en: 'Rewrite as ln(x) / (1/x^2), an infinity/infinity form.', id: 'Tulis ulang sebagai ln(x) / (1/x^2), bentuk tak hingga/tak hingga.' },
              ],
              explain: {
                en: "L'Hôpital: (1/x) / (-2/x^3) = -x^2/2, which approaches 0 as x approaches 0.",
                id: "L'Hôpital: (1/x) / (-2/x^3) = -x^2/2, yang mendekati 0 saat x mendekati 0.",
              },
            },
          ],
        },
      ...
      project: {
        ...
        tasks: [
          {
            prompt: { en: 'Evaluate the limit of (1 - cos x)/x^2 as x approaches 0.', id: 'Hitung limit dari (1 - cos x)/x^2 saat x mendekati 0.' },
            blanks: [{ answer: 0.5 }],
            solution: ["\\lim \\dfrac{\\sin x}{2x} = \\lim\\dfrac{\\cos x}{2} = \\dfrac12"],
          },
          {
            prompt: { en: 'Evaluate the limit of (ln x)/(x - 1) as x approaches 1.', id: 'Hitung limit dari (ln x)/(x - 1) saat x mendekati 1.' },
            blanks: [{ answer: 1 }],
            solution: ["\\lim \\dfrac{1/x}{1} = 1"],
          },
          {
            prompt: { en: 'Evaluate the limit of x · e^(1/x) - x as x approaches infinity. (This is an infinity times 0 form after rewriting; round to two decimal places.)', id: 'Hitung limit dari x · e^(1/x) - x saat x mendekati tak hingga. (Ini bentuk tak hingga kali 0 setelah ditulis ulang; bulatkan ke dua desimal.)' },
            blanks: [{ answer: 1 }],
          ...
          steps: [
            ...
            },
            {
              ...
              figure: {
                ...
                caption: {
                  en: 'A(x) = 100x - 2x^2 on [0, 50] — the area function peaks at exactly the critical point x = 25, and drops to 0 at both endpoints where the rectangle degenerates.',
                  id: 'A(x) = 100x - 2x^2 pada [0, 50] — fungsi luasnya memuncak tepat di titik kritis x = 25, dan turun ke 0 di kedua titik ujung tempat persegi panjangnya merosot.',
                },
              },
            },
            {
          ...
          steps: [
            {
              ...
              figure: {
                ...
                items: [
                  ...
                  { t: 'dot', x: 1.5, y: 0, color: 'result', label: 'x_1' },
                ],
                caption: {
                  en: 'The tangent to f(x) = x^2 - 2 at the guess x_0 = 1 crosses the x-axis at x_1 = 1.5 — already closer to the true root, sqrt(2) ≈ 1.41421.',
                  id: 'Garis singgung f(x) = x^2 - 2 pada tebakan x_0 = 1 memotong sumbu-x di x_1 = 1.5 — sudah lebih dekat ke akar sebenarnya, sqrt(2) ≈ 1.41421.',
                },
              },
            },
            {
            ...
            },
            {
              ...
              explain: {
                en: 'x_1 = 2 - (4-5)/4 = 2 + 0.25 = 2.25, already close to sqrt(5) ≈ 2.2361.',
                id: 'x_1 = 2 - (4-5)/4 = 2 + 0.25 = 2.25, sudah dekat dengan sqrt(5) ≈ 2.2361.',
              },
            },
          ],
        },
