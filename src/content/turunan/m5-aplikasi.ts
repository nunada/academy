          ...
          steps: [
            ...
            },
            {
              ...
              figure: {
                ...
                ySpan: [-1, 11],
                ticks: true,
                params: [{ name: 'b', min: 1, max: 9.9, step: 0.1, value: 6, label: 'x' }],
                items: [
                  { t: 'seg', from: [0, 0], to: [0, 10], color: 'muted', dashed: true, label: 'dinding' },
                  { t: 'seg', from: [0, 0], to: [10, 0], color: 'muted', dashed: true, label: 'tanah' },
                  { t: 'curve', f: 'sqrt(100-b^2)-(sqrt(100-b^2)/b)*x', color: 'a', label: 'tangga' },
                  { t: 'dot', x: 'b', y: 0, color: 'result', label: 'bawah' },
                  { t: 'dot', x: 0, y: 'sqrt(100-b^2)', color: 'b', label: 'atas' },
                ],
                caption: {
                  en: 'Drag the base away from the wall: the top slides down, and it does so faster than the base moves out — exactly the $-1.5$ m/s found by the calculation at $x=6$.',
                  id: 'Geser jarak kaki tangga menjauhi dinding: ujung atasnya turun, dan itu terjadi lebih cepat daripada kaki tangga bergerak menjauh — persis $-1{,}5$ m/detik yang ditemukan penghitungan di $x=6$.',
                },
              },
            },
            {
          ...
          steps: [
            ...
            },
            {
              ...
              figure: {
                ...
                ySpan: [0, 3],
                ticks: true,
                params: [{ name: 'a', min: 0.5, max: 6, step: 0.1, value: 4 }],
                items: [
                  { t: 'curve', f: 'sqrt(x)', from: 0.01, color: 'a' },
                  { t: 'curve', f: 'sqrt(a)+(1/(2*sqrt(a)))*(x-a)', color: 'b', dashed: true, label: 'L(x)' },
                  { t: 'dot', x: 'a', y: 'sqrt(a)', color: 'c', label: 'a' },
                ],
                caption: {
                  en: 'Move the point of tangency $a$: right at $a$ the line and the curve touch exactly, and the further $x$ strays from $a$, the more visibly the straight line and the curved one pull apart.',
                  id: 'Geser titik singgungnya $a$: tepat di $a$ garis dan kurvanya bersinggungan persis, dan makin jauh $x$ menyimpang dari $a$, makin tampak garis lurus dan kurvanya berpisah.',
                },
              },
            },
            {
            ...
            },
            {
              ...
              figure: {
                ...
                items: [
                  ...
                  { t: 'curve', f: '(x0^3-3*x0)+(3*x0^2-3)*(x-x0)', color: 'result', dashed: true, label: 'tangent' },
                  { t: 'dot', x: 'x0', y: 'x0^3-3*x0', color: 'result', label: 'P' },
                ],
                caption: {
                  en: 'Slide $P$ across the curve: the tangent tilts up (increasing) or down (decreasing) exactly following the sign pattern the first derivative test predicted, flipping right at each marked point.',
                  id: 'Geser $P$ sepanjang kurva: garis singgungnya miring naik (naik) atau turun (turun) persis mengikuti pola tanda yang diprediksi uji turunan pertama, berbalik tepat di tiap titik yang ditandai.',
                },
              },
            },
            {
          ...
          steps: [
            ...
            },
            {
              ...
              figure: {
                ...
                caption: {
                  en: 'Slide $P$ through the inflection point: left of $(0,0)$ the tangent sits above the curve (concave down, capping over); right of it, the tangent sits below the curve (concave up, cupping under) — the flip happens exactly at the inflection point.',
                  id: 'Geser $P$ melewati titik beloknya: di sebelah kiri $(0,0)$ garis singgungnya berada di atas kurva (cekung ke bawah, melengkung menutup); di sebelah kanannya, garis singgungnya berada di bawah kurva (cekung ke atas, melengkung membuka) — pembalikannya terjadi persis di titik beloknya.',
                },
              },
            },
            {
