          ...
          steps: [
            {
              ...
              figure: {
                ...
                ySpan: [0, 13],
                ticks: true,
                params: [{ name: 'eps', min: 0.5, max: 4, step: 0.25, value: 1.5, label: 'ε' }],
                items: [
                  { t: 'curve', f: 'x^2', color: 'a', label: 'x²' },
                  { t: 'hline', y: '9+eps', color: 'muted', dashed: true },
                  { t: 'hline', y: '9-eps', color: 'muted', dashed: true },
                  { t: 'vline', x: 'sqrt(9+eps)', color: 'b', dashed: true },
                  { t: 'vline', x: 'sqrt(9-eps)', color: 'b', dashed: true },
                  { t: 'dot', x: 3, y: 9, color: 'result' },
                ],
                caption: {
                  en: 'Shrink $\\varepsilon$ and watch the two dashed vertical lines, at $\\sqrt{9-\\varepsilon}$ and $\\sqrt{9+\\varepsilon}$ — they never sit the same distance from $x=3$. That gap between them is exactly why $\\delta$ has to be the nearer one, not their average.',
                  id: 'Kecilkan $\\varepsilon$ dan amati kedua garis tegak putus-putus, di $\\sqrt{9-\\varepsilon}$ dan $\\sqrt{9+\\varepsilon}$ — keduanya tak pernah berjarak sama dari $x=3$. Celah di antara keduanya itulah persis sebabnya $\\delta$ harus diambil yang lebih dekat, bukan rata-ratanya.',
                },
              },
            },
            {
          ...
          steps: [
            {
              ...
              figure: {
                ...
                ySpan: [-0.5, 5.5],
                ticks: true,
                params: [{ name: 'delta', min: 0.02, max: 0.9, step: 0.02, value: 0.5, label: 'δ' }],
                items: [
                  ...
                  { t: 'vline', x: '1-delta', color: 'b', dashed: true },
                  { t: 'vline', x: '1+delta', color: 'b', dashed: true },
                  { t: 'hline', y: 2.4, color: 'muted', dashed: true },
                  { t: 'hline', y: 1.6, color: 'muted', dashed: true },
                ],
                caption: {
                  en: 'Shrink $\\delta$ as far as you like — the window it opens around $x=1$ always keeps points just to its right where $f(x)$ sits near $3$, permanently outside the band $(1.6, 2.4)$ around the claimed limit $2$.',
                  id: 'Kecilkan $\\delta$ sekecil apa pun — jendela yang dibukanya di sekitar $x=1$ selalu memuat titik tepat di kanannya tempat $f(x)$ berada dekat $3$, tetap di luar pita $(1.6, 2.4)$ di sekitar limit yang diklaim, $2$.',
                },
              },
            },
            {
