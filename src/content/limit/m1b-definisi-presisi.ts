  ...
  submodules: [
    /* ------------------------------------------------- 1. the epsilon-delta definition */
    {
      ...
      lessons: [
        {
          ...
          steps: [
            ...
            },
            {
              ...
              blanks: ['2', '2'],
              explain: {
                en: 'Factoring 2x - 6 gives 2|x-3|, so the inequality 2|x-3| < epsilon rearranges to |x-3| < epsilon/2 — delta is epsilon divided by the coefficient of x.',
                id: 'Memfaktorkan 2x - 6 memberi 2|x-3|, sehingga pertidaksamaan 2|x-3| < epsilon ditata ulang menjadi |x-3| < epsilon/2 — delta adalah epsilon dibagi koefisien x-nya.',
              },
            },
            {
              kind: 'math',
              id: 'm1',
              prompt: {
                en: 'For the limit of (4x - 5) as x approaches 2 (which equals 3), find the delta that works for epsilon = 0.02.',
                id: 'Untuk limit dari (4x - 5) saat x mendekati 2 (yang sama dengan 3), cari delta yang berhasil untuk epsilon = 0.02.',
              },
              blanks: [{ answer: 0.005 }],
              hints: [
                { en: '|(4x-5)-3| = 4|x-2|, so delta = epsilon/4.', id: '|(4x-5)-3| = 4|x-2|, sehingga delta = epsilon/4.' },
              ],
              explain: {
        ...
        },
        {
          ...
          steps: [
            ...
            },
            {
              ...
              math: true,
              prompt: {
                en: 'Order the two-step method as applied to proving the limit of x^2 as x approaches 3 equals 9, for a given epsilon.',
                id: 'Susun metode dua langkah yang diterapkan untuk membuktikan limit dari x^2 saat x mendekati 3 sama dengan 9, untuk epsilon tertentu.',
              },
              lines: [
            ...
            },
            {
              ...
              id: 'm1',
              prompt: {
                en: 'For the limit of x^2 as x approaches 2 (which equals 4), with epsilon = 0.5, find the two candidate distances and report the smaller one as delta. (Round to 4 decimal places.)',
                id: 'Untuk limit dari x^2 saat x mendekati 2 (yang sama dengan 4), dengan epsilon = 0.5, cari kedua jarak kandidatnya dan laporkan yang lebih kecil sebagai delta. (Bulatkan ke 4 desimal.)',
              },
              blanks: [{ answer: 0.1213, tol: 0.001 }],
              hints: [
                { en: 'sqrt(3.5) ≈ 1.8708 and sqrt(4.5) ≈ 2.1213.', id: 'sqrt(3.5) ≈ 1.8708 dan sqrt(4.5) ≈ 2.1213.' },
              ],
              explain: {
      ...
      project: {
        ...
        requirements: [
          { en: 'A linear function\'s delta is epsilon divided by the size of its slope.', id: 'Delta fungsi linear adalah epsilon dibagi besar kemiringannya.' },
        ...
        tasks: [
          {
            prompt: { en: 'For the limit of (5x + 2) as x approaches 1 (which equals 7), find delta for epsilon = 0.1.', id: 'Untuk limit dari (5x + 2) saat x mendekati 1 (yang sama dengan 7), cari delta untuk epsilon = 0.1.' },
            blanks: [{ answer: 0.02 }],
            solution: ['|(5x+2)-7| = 5|x-1| < \\varepsilon \\Rightarrow \\delta = \\varepsilon/5 = 0{,}02'],
          },
          {
            prompt: { en: 'For the limit of (-2x + 3) as x approaches -1 (which equals 5), find delta for epsilon = 0.06.', id: 'Untuk limit dari (-2x + 3) saat x mendekati -1 (yang sama dengan 5), cari delta untuk epsilon = 0.06.' },
            blanks: [{ answer: 0.03 }],
            solution: ['|(-2x+3)-5| = 2|x+1| < \\varepsilon \\Rightarrow \\delta = \\varepsilon/2 = 0{,}03'],
          },
          {
            prompt: { en: 'For the limit of x^2 as x approaches 4 (which equals 16), with epsilon = 1, find the two candidate distances and report the smaller as delta. (Round to 4 decimal places.)', id: 'Untuk limit dari x^2 saat x mendekati 4 (yang sama dengan 16), dengan epsilon = 1, cari kedua jarak kandidatnya dan laporkan yang lebih kecil sebagai delta. (Bulatkan ke 4 desimal.)' },
    ...
    /* ----------------------------------------------------- 2. proving and disproving */
    {
      ...
      lessons: [
        {
          ...
          steps: [
            ...
            },
            {
              ...
              id: 'q1',
              prompt: {
                en: 'Why is the tolerance split into epsilon/2 for each of f and g, rather than epsilon for each?',
                id: 'Mengapa toleransinya dibagi menjadi epsilon/2 untuk masing-masing f dan g, bukan epsilon untuk masing-masing?',
              },
              options: [
                { en: 'So that the two errors, added together by the triangle inequality, total at most epsilon rather than 2 epsilon', id: 'Agar kedua galatnya, dijumlahkan lewat pertidaksamaan segitiga, bertotal paling banyak epsilon, bukan 2 epsilon' },
                { en: 'Because delta must always be exactly half of epsilon', id: 'Sebab delta selalu harus tepat setengah dari epsilon' },
              ...
              answer: 0,
              explain: {
                en: 'The triangle inequality bounds the total error by the sum of the two individual errors. Keeping each individual error under epsilon/2 makes that sum come out under epsilon exactly — using epsilon for each would only guarantee a bound of 2 epsilon.',
                id: 'Pertidaksamaan segitiga membatasi total galat dengan jumlah kedua galat individunya. Menjaga tiap galat individu di bawah epsilon/2 membuat jumlah itu keluar tepat di bawah epsilon — memakai epsilon untuk masing-masing hanya akan menjamin batas 2 epsilon.',
              },
            },
            {
              kind: 'fill',
              ...
              blanks: ['2', '2'],
              explain: {
                en: 'Each piece is held under epsilon/2 by construction, and the two halves recombine to exactly epsilon.',
                id: 'Tiap bagian dijaga di bawah epsilon/2 menurut konstruksinya, dan kedua setengahnya bergabung kembali menjadi tepat epsilon.',
              },
            },
            {
              kind: 'math',
              id: 'm1',
              prompt: {
                en: 'In the sum rule proof, if delta_1 = 0.03 and delta_2 = 0.05 for a given epsilon, what value must the final delta be?',
                id: 'Dalam bukti hukum jumlah, jika delta_1 = 0.03 dan delta_2 = 0.05 untuk epsilon tertentu, berapa nilai delta akhir yang harus dipakai?',
              },
              blanks: [{ answer: 0.03 }],
              hints: [
        ...
        },
        {
          ...
          steps: [
            ...
            },
            {
              ...
              id: 'q1',
              prompt: {
                en: 'To disprove a claimed limit, how many values of epsilon must be shown to defeat every delta?',
                id: 'Untuk menyangkal limit yang diklaim, berapa banyak nilai epsilon yang harus ditunjukkan mengalahkan setiap delta?',
              },
              options: [
                { en: 'Just one — a single epsilon for which no delta works is enough', id: 'Hanya satu — satu epsilon yang untuknya tak ada delta yang berhasil sudah cukup' },
                { en: 'Every possible epsilon must be checked individually', id: 'Setiap epsilon yang mungkin harus diperiksa satu per satu' },
              ...
              answer: 0,
              explain: {
                en: 'Proving needs a working delta for every epsilon; disproving is the logical negation, so exhibiting just one epsilon that defeats every delta is sufficient to break the universal claim.',
                id: 'Membuktikan memerlukan delta yang berhasil untuk setiap epsilon; menyangkal adalah negasi logisnya, sehingga menunjukkan hanya satu epsilon yang mengalahkan setiap delta sudah cukup untuk mematahkan klaim universalnya.',
              },
            },
            {
              kind: 'quiz',
              id: 'q2',
              prompt: {
                en: 'Reading the figure above, why does epsilon = 0.4 defeat the claim that the limit at x = 1 is 2?',
                id: 'Dengan membaca gambar di atas, mengapa epsilon = 0.4 mengalahkan klaim bahwa limit di x = 1 adalah 2?',
              },
              figure: {
                dim: 2,
                xSpan: [-0.5, 2.5],
              ...
              options: [
                ...
                { en: 'Epsilon = 0.4 is larger than the jump itself', id: 'Epsilon = 0.4 lebih besar dari lompatannya sendiri' },
              ],
              answer: 0,
              explain: {
            ...
            },
            {
              ...
              id: 'm1',
              prompt: {
                en: 'A function jumps from 5 to 8 at x = 2. What is the largest epsilon guaranteed to defeat any claimed limit value at x = 2? (Half the jump size.)',
                id: 'Sebuah fungsi melompat dari 5 ke 8 di x = 2. Berapa epsilon terbesar yang dijamin mengalahkan nilai limit yang diklaim di x = 2? (Setengah besar lompatannya.)',
              },
              blanks: [{ answer: 1.5 }],
              hints: [
              ...
              explain: {
                en: 'Half of 3 is 1.5 — any epsilon up to this size is small enough that no single L can keep both sides of the jump within epsilon of it.',
                id: 'Setengah dari 3 adalah 1.5 — epsilon berapa pun hingga besar ini cukup kecil sehingga tak ada satu L pun yang bisa menjaga kedua sisi lompatannya dalam jarak epsilon darinya.',
              },
            },
          ],
        },
      ...
      project: {
        ...
        requirements: [
          ...
          { en: 'A jump of size J can always be defeated by any epsilon up to J/2.', id: 'Lompatan sebesar J selalu bisa dikalahkan oleh epsilon berapa pun hingga J/2.' },
        ],
        tasks: [
          {
            prompt: { en: 'In a sum rule proof, delta_1 = 0.12 and delta_2 = 0.07 for a given epsilon. What is the final delta?', id: 'Dalam bukti hukum jumlah, delta_1 = 0.12 dan delta_2 = 0.07 untuk epsilon tertentu. Berapa delta akhirnya?' },
            blanks: [{ answer: 0.07 }],
            solution: ['\\delta = \\min\\{0{,}12,\\ 0{,}07\\} = 0{,}07'],
          },
          {
            prompt: { en: 'A function jumps from 10 to 16 at x = 5. What is the largest epsilon guaranteed to defeat any claimed limit at x = 5?', id: 'Sebuah fungsi melompat dari 10 ke 16 di x = 5. Berapa epsilon terbesar yang dijamin mengalahkan limit yang diklaim di x = 5?' },
            blanks: [{ answer: 3 }],
            solution: ['\\text{jump} = 16-10 = 6, \\quad \\varepsilon = 6/2 = 3'],
          },
          {
            prompt: { en: 'A function jumps from -2 to 3 at x = 0. What is the largest epsilon guaranteed to defeat any claimed limit at x = 0?', id: 'Sebuah fungsi melompat dari -2 ke 3 di x = 0. Berapa epsilon terbesar yang dijamin mengalahkan limit yang diklaim di x = 0?' },
            blanks: [{ answer: 2.5 }],
