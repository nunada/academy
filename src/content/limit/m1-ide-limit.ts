          ...
          steps: [
            {
              ...
              figure: {
                ...
                ySpan: [-1, 9],
                ticks: true,
                params: [{ name: 'd', min: 0.05, max: 2, step: 0.05, value: 1.2, label: 'd' }],
                items: [
                  { t: 'curve', f: 'x^2/2+1', color: 'a', label: 'f(x)' },
                  { t: 'dot', x: 2, y: 3, color: 'result', label: 'L' },
                  { t: 'dot', x: '2-d', y: '(2-d)^2/2+1', color: 'b', label: 'x' },
                  { t: 'dot', x: '2+d', y: '(2+d)^2/2+1', color: 'c', label: 'x' },
                ],
                caption: {
                  en: 'Drag $d$ toward $0$ — both marked points slide along the curve toward $(2,3)$ from either side, but neither one ever actually reaches $x=2$: that is what "approaching, never arriving" looks like.',
                  id: 'Geser $d$ menuju $0$ — kedua titik yang ditandai bergeser sepanjang kurva menuju $(2,3)$ dari kedua sisi, tetapi tak satu pun pernah benar-benar mencapai $x=2$: itulah rupa "mendekati, tak pernah tiba".',
                },
              },
            },
            {
          ...
          steps: [
            {
              ...
              figure: {
                ...
                ySpan: [-1, 8],
                ticks: true,
                params: [{ name: 'd', min: 0.35, max: 1.5, step: 0.05, value: 1, label: '|x|' }],
                items: [
                  { t: 'curve', f: '1/x^2', color: 'a', label: '1/x²' },
                  { t: 'dot', x: 'd', y: '1/d^2', color: 'b', label: 'x' },
                  { t: 'dot', x: '-d', y: '1/d^2', color: 'c', label: 'x' },
                ],
                caption: {
                  en: 'Shrink $|x|$ toward $0$ — both marked points rocket upward past any height you fix. Neither side settles near a number; there is nothing for the limit to equal.',
                  id: 'Kecilkan $|x|$ menuju $0$ — kedua titik yang ditandai melesat ke atas melewati ketinggian berapa pun yang kamu tetapkan. Tak satu sisi pun mereda mendekati suatu bilangan; tak ada apa pun yang bisa disamakan dengan limitnya.',
                },
              },
            },
            {
          ...
          steps: [
            {
              ...
              figure: {
                ...
                ySpan: [-1, 6],
                ticks: true,
                params: [{ name: 'd', min: -1.5, max: 1.5, step: 0.05, value: 0.8, label: 'x−1' }],
                items: [
                  { t: 'curve', f: '(x^2-1)/(x-1)', color: 'a' },
                  { t: 'dot', x: 1, y: 2, open: true, color: 'a' },
                  { t: 'dot', x: 1, y: 5, color: 'b' },
                  { t: 'dot', x: '1+d', y: '((1+d)^2-1)/((1+d)-1)', color: 'c', label: 'x' },
                ],
                caption: {
                  en: 'Drag $x-1$ toward $0$ — the moving point slides along the curve straight into the hollow spot at $(1,2)$; that is the limit. Someone has separately decreed $f(1) = 5$, the filled dot well off the curve. The limit never noticed.',
                  id: 'Geser $x-1$ menuju $0$ — titik yang bergerak meluncur sepanjang kurva tepat menuju titik kosong di $(1,2)$; itulah limitnya. Seseorang secara terpisah menetapkan $f(1) = 5$, titik penuh yang jauh dari kurva. Limitnya sama sekali tak terpengaruh.',
                },
              },
            },
            {
