          ...
          steps: [
            ...
            },
            {
              ...
              figure: {
                ...
                caption: {
                  en: 'The curve is the line $y = x+1$ with a hole punched out at $x = 1$. Sliding along it from either side, the height heads straight for the hole — for $2$ — even though the point itself is missing.',
                  id: 'Kurvanya adalah garis $y = x+1$ dengan lubang di $x = 1$. Menyusurinya dari sisi mana pun, tingginya menuju tepat ke lubang itu — ke $2$ — meskipun titiknya sendiri hilang.',
                },
              },
            },
            {
          ...
          steps: [
            {
              ...
              figure: {
                ...
                caption: {
                  en: 'From the left the curve heads for height $2$; from the right, for height $3$. The two one-sided limits disagree, so the two-sided limit at $x = 1$ does not exist — even though the function is perfectly defined there (the filled dot).',
                  id: 'Dari kiri kurvanya menuju tinggi $2$; dari kanan, menuju tinggi $3$. Kedua limit sepihaknya tidak sepakat, jadi limit dua sisi di $x = 1$ tidak ada — meskipun fungsinya justru terdefinisi sempurna di situ (titik penuh).',
                },
              },
            },
            {
