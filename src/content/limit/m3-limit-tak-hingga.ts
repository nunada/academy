          ...
          steps: [
            {
              ...
              figure: {
                ...
                ySpan: [-1, 8],
                ticks: true,
                params: [{ name: 'd', min: 0.35, max: 1.5, step: 0.05, value: 1, label: '|x−1|' }],
                items: [
                  { t: 'curve', f: '1/(x-1)^2', color: 'a' },
                  { t: 'vline', x: 1, color: 'muted', dashed: true },
                  { t: 'dot', x: '1+d', y: '1/d^2', color: 'b', label: 'x' },
                  { t: 'dot', x: '1-d', y: '1/d^2', color: 'c', label: 'x' },
                ],
                caption: {
                  en: 'Shrink $|x-1|$ toward $0$ — both marked points rocket upward past any height you fix. We say $\\lim_{x \\to 1}\\frac{1}{(x-1)^2} = \\infty$, and the dashed line at $x=1$ is the **vertical asymptote** it describes.',
                  id: 'Kecilkan $|x-1|$ menuju $0$ — kedua titik yang ditandai melesat ke atas melewati ketinggian berapa pun. Kita katakan $\\lim_{x \\to 1}\\frac{1}{(x-1)^2} = \\infty$, dan garis putus-putus di $x=1$ adalah **asimtot tegak** yang digambarkannya.',
                },
              },
            },
            {
          ...
          steps: [
            {
              ...
              figure: {
                ...
                ySpan: [-8, 8],
                ticks: true,
                params: [{ name: 'd', min: 0.45, max: 2, step: 0.05, value: 1, label: '|x−2|' }],
                items: [
                  { t: 'curve', f: '(x+1)/(x-2)', color: 'a' },
                  { t: 'vline', x: 2, color: 'muted', dashed: true },
                  { t: 'dot', x: '2+d', y: '(3+d)/d', color: 'c', label: 'x from right' },
                  { t: 'dot', x: '2-d', y: '-(3-d)/d', color: 'result', label: 'x from left' },
                ],
                caption: {
                  en: 'Shrink $|x-2|$ toward $0$: the right-hand point rockets to $+\\infty$ while the left-hand point plunges to $-\\infty$ — opposite runaways on the two sides of the same vertical asymptote, since the numerator stays $3 \\neq 0$ right where the denominator vanishes.',
                  id: 'Kecilkan $|x-2|$ menuju $0$: titik kanan melesat ke $+\\infty$ sementara titik kiri terjun ke $-\\infty$ — larian berlawanan di kedua sisi asimtot tegak yang sama, sebab pembilangnya tetap $3 \\neq 0$ tepat di tempat penyebutnya lenyap.',
                },
              },
            },
            {
          ...
          steps: [
            {
              ...
              figure: {
                ...
                ySpan: [-2, 6],
                ticks: true,
                params: [{ name: 'xv', min: 2, max: 30, step: 1, value: 5, label: 'x' }],
                items: [
                  { t: 'curve', f: '(2*x+1)/(x-1)', color: 'a' },
                  { t: 'hline', y: 2, color: 'muted', dashed: true },
                  { t: 'dot', x: 'xv', y: '(2*xv+1)/(xv-1)', color: 'b', label: 'x' },
                ],
                caption: {
                  en: 'Push $x$ farther out and watch the marked point hug the dashed line $y = 2$ ever more closely — that is $\\lim_{x \\to \\infty} \\dfrac{2x+1}{x-1} = 2$, the horizontal asymptote.',
                  id: 'Dorong $x$ semakin jauh dan amati titik yang ditandai kian merapat ke garis putus-putus $y = 2$ — itulah $\\lim_{x \\to \\infty} \\dfrac{2x+1}{x-1} = 2$, asimtot datarnya.',
                },
              },
            },
            {
