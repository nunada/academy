          ...
          steps: [
            {
              ...
              body: {
                en: 'Using the squeeze theorem is always the same three checks, in order:\n\n- Confirm $g(x) \\leq f(x) \\leq h(x)$ near $a$.\n- Compute $\\lim_{x\\to a} g(x)$ and $\\lim_{x\\to a} h(x)$ separately — ordinary limits, by whatever technique fits.\n- Confirm the two agree. If they do, that shared value is $\\lim_{x\\to a} f(x)$ too, no further work needed.\n\nThe target does not have to be $0$. If $g(x) \\to 5$ and $h(x) \\to 5$, the trapped function is squeezed to $5$ — the theorem cares only that the walls meet, not what they meet at.',
                id: 'Memakai teorema apit selalu tiga pemeriksaan yang sama, berurutan:\n\n- Pastikan $g(x) \\leq f(x) \\leq h(x)$ dekat $a$.\n- Hitung $\\lim_{x\\to a} g(x)$ dan $\\lim_{x\\to a} h(x)$ secara terpisah — limit biasa, dengan teknik apa pun yang cocok.\n- Pastikan keduanya sepakat. Bila iya, nilai bersama itu jugalah $\\lim_{x\\to a} f(x)$, tanpa kerja tambahan.\n\nTargetnya tak harus $0$. Bila $g(x) \\to 5$ dan $h(x) \\to 5$, fungsi yang terjepit dipaksa menuju $5$ — teoremanya hanya peduli kedua dindingnya bertemu, bukan di mana mereka bertemu.',
              },
              figure: {
                dim: 2,
                xSpan: [-2, 2],
          ...
          steps: [
            {
              ...
              figure: {
                ...
                items: [
                  ...
                  { t: 'dot', x: 'd', y: 'sin(d)/d', color: 'b', label: 'x' },
                  { t: 'dot', x: '-d', y: 'sin(-d)/(-d)', color: 'c', label: 'x' },
                ],
                caption: {
                  en: 'Drag $x$ toward $0$ from either side — both moving points slide along the curve straight into the hollow point at height $1$. The function is not even defined at $x=0$, yet that is exactly what the limit heads for.',
                  id: 'Geser $x$ menuju $0$ dari sisi mana pun — kedua titik yang bergerak meluncur sepanjang kurva tepat menuju titik kosong pada tinggi $1$. Fungsinya bahkan tak terdefinisi di $x=0$, namun itulah persis yang dituju limitnya.',
                },
              },
            },
            {
          ...
          steps: [
            {
              ...
              figure: {
                ...
                items: [
                  ...
                  { t: 'dot', x: 'd', y: '(1-cos(d))/d', color: 'b', label: 'x' },
                  { t: 'dot', x: '-d', y: '(1-cos(-d))/(-d)', color: 'c', label: 'x' },
                ],
                caption: {
                  en: 'Drag $x$ toward $0$ from either side — both moving points slide along the curve straight into the hollow point at height $0$, undefined right at $x=0$ itself — the second limit this lesson derives.',
                  id: 'Geser $x$ menuju $0$ dari sisi mana pun — kedua titik yang bergerak meluncur sepanjang kurva tepat menuju titik kosong pada tinggi $0$, tak terdefinisi tepat di $x=0$ itu sendiri — limit kedua yang diturunkan pelajaran ini.',
                },
              },
            },
            {
