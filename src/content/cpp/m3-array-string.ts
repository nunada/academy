          ...
          steps: [
            {
              ...
              figure: {
                ...
                height: 260,
                items: [
                  { t: 'poly', pts: [[0.5, 2], [2.9, 2], [2.9, 5], [0.5, 5]], color: 'a', label: '80' },
                  { t: 'poly', pts: [[3.2, 2], [5.6, 2], [5.6, 5], [3.2, 5]], color: 'a', label: '90' },
                  { t: 'poly', pts: [[5.9, 2], [8.3, 2], [8.3, 5], [5.9, 5]], color: 'muted' },
                  { t: 'poly', pts: [[8.6, 2], [11, 2], [11, 5], [8.6, 5]], color: 'muted' },
                  { t: 'poly', pts: [[11.3, 2], [13.7, 2], [13.7, 5], [11.3, 5]], color: 'muted' },
                  { t: 'poly', pts: [[0.5, 0.6], [2.9, 0.6], [2.9, 1.5], [0.5, 1.5]], color: 'muted', label: '[0]' },
                  { t: 'poly', pts: [[3.2, 0.6], [5.6, 0.6], [5.6, 1.5], [3.2, 1.5]], color: 'muted', label: '[1]' },
                  { t: 'poly', pts: [[5.9, 0.6], [8.3, 0.6], [8.3, 1.5], [5.9, 1.5]], color: 'muted', label: '[2]' },
                  { t: 'poly', pts: [[8.6, 0.6], [11, 0.6], [11, 1.5], [8.6, 1.5]], color: 'muted', label: '[3]' },
                  { t: 'poly', pts: [[11.3, 0.6], [13.7, 0.6], [13.7, 1.5], [11.3, 1.5]], color: 'muted', label: '[4]' },
                ],
                caption: {
                  en: 'Five boxes in a row, all named scores, reached only by the index underneath — scores[0] and scores[1] have been filled in, the rest still wait for a value.',
                  id: 'Lima kotak berjajar, semuanya bernama nilai, hanya bisa diraih lewat indeks di bawahnya — nilai[0] dan nilai[1] sudah diisi, sisanya masih menunggu nilai.',
                },
              },
              code: {
