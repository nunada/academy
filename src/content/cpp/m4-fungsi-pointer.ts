  ...
  submodules: [
    /* -------------------------------------------------------- 4.1 functions */
    {
      ...
      lessons: [
        {
          ...
          steps: [
            ...
            },
            {
              ...
              code: {
                en: 'int multiply(int a, int b) {\n    return a * b;\n}\nint main() {\n    cout << multiply(6, 7) << endl;\n}',
                id: 'int kali(int a, int b) {\n    return a * b;\n}\nint main() {\n    cout << kali(6, 7) << endl;\n}',
              },
              options: [
                { en: '42', id: '42' },
                { en: '13', id: '13' },
                { en: '67', id: '67' },
                { en: 'Nothing — multiply is never called', id: 'Tidak ada — kali tak pernah dipanggil' },
              ],
              answer: 0,
              explain: {
            ...
            },
            {
              ...
              template: {
                en: 'int maximum(int a, int b) {\n    if (a > b) ___ a;\n    return b;\n}',
                id: 'int maksimum(int a, int b) {\n    if (a > b) ___ a;\n    return b;\n}',
              },
              blanks: ['return'],
              explain: {
            ...
            },
            {
              ...
              id: 'w1',
              prompt: {
                en: 'Write `int area(int p, int l)` returning the area of a rectangle, then use it to print the area of an 8 by 5 rectangle.',
              ...
              hints: [
                { en: 'int area(int p, int l) { return p * l; }', id: 'int luas(int p, int l) { return p * l; }' },
                { en: 'cout << area(8, 5) << endl;', id: 'cout << luas(8, 5) << endl;' },
              ],
              solution: {
        ...
        },
        {
          ...
          steps: [
            ...
            },
            {
              ...
              id: 'w1',
              prompt: {
                en: 'Write `void printBox(int n)` that prints an n by n box of `*`, then call it with 3.',
                id: 'Tulis `void cetakKotak(int n)` yang mencetak kotak `*` berukuran n kali n, lalu panggil dengan 3.',
              },
              starter: {
                en: '#include <iostream>\nusing namespace std;\n\n// write the printBox function here\n\nint main() {\n\n    return 0;\n}',
              ...
              hints: [
                ...
                { en: 'void printBox(int n) { for (...) { for (...) cout << "*"; cout << endl; } }', id: 'void cetakKotak(int n) { for (...) { for (...) cout << "*"; cout << endl; } }' },
              ],
              solution: {
        ...
        },
        {
          ...
          steps: [
            ...
            },
            {
              kind: 'quiz',
              id: 'q1',
              prompt: { en: 'After increment(values, 3) runs below, what does main print?', id: 'Setelah naikkan(nilai, 3) berjalan di bawah, apa yang dicetak main?' },
              code: {
                en: 'void increment(int arr[], int n) {\n    for (int i = 0; i < n; i++) arr[i]++;\n}\nint main() {\n    int values[3] = {5, 5, 5};\n    increment(values, 3);\n    // print values[0]\n}',
            ...
            },
            {
              ...
              template: {
                en: 'int countNegative(int arr[], int ___) {\n    int c = 0;\n    for (int i = 0; i < n; i++) if (arr[i] < 0) c++;\n    return c;\n}',
                id: 'int hitungNegatif(int arr[], int ___) {\n    int c = 0;\n    for (int i = 0; i < n; i++) if (arr[i] < 0) c++;\n    return c;\n}',
              },
              blanks: ['n'],
              explain: {
            ...
            },
            {
              ...
              id: 'w1',
              prompt: {
                en: 'Write `void multiplyBy(int arr[], int n, int factor)` that multiplies every element by factor in place. Apply it to `{1,2,3,4}` with factor 3 and print the result, space-separated.',
              ...
              starter: {
                en: '#include <iostream>\nusing namespace std;\n\n// write the multiplyBy function here\n\nint main() {\n    int values[4] = {1, 2, 3, 4};\n\n    return 0;\n}',
                id: '#include <iostream>\nusing namespace std;\n\n// tulis fungsi kalikan di sini\n\nint main() {\n    int nilai[4] = {1, 2, 3, 4};\n\n    return 0;\n}',
              },
              tests: [{ name: { en: 'Prints 3 6 9 12', id: 'Mencetak 3 6 9 12' }, expectOutput: '3 6 9 12 ' }],
              hints: [
                { en: 'void multiplyBy(int arr[], int n, int factor) { for (...) arr[i] *= factor; }', id: 'void kalikan(int arr[], int n, int faktor) { for (...) arr[i] *= faktor; }' },
                { en: 'Print the array with a loop after calling multiplyBy.', id: 'Cetak array-nya dengan perulangan setelah memanggil kalikan.' },
              ],
              solution: {
                en: '#include <iostream>\nusing namespace std;\n\nvoid multiplyBy(int arr[], int n, int factor) {\n    for (int i = 0; i < n; i++) {\n        arr[i] *= factor;\n    }\n}\n\nint main() {\n    int values[4] = {1, 2, 3, 4};\n    multiplyBy(values, 4, 3);\n    for (int i = 0; i < 4; i++) cout << values[i] << " ";\n    cout << endl;\n    return 0;\n}',
      ...
      project: {
        ...
        requirements: [
          { en: 'Write add, subtract and multiply, each taking two ints and returning an int.', id: 'Tulis tambah, kurang, dan kali, masing-masing menerima dua int dan mengembalikan int.' },
          { en: 'Write divide taking two ints and returning a double, computed without losing the fraction.', id: 'Tulis bagi menerima dua int dan mengembalikan double, dihitung tanpa kehilangan pecahannya.' },
        ...
        starter: {
          en: '#include <iostream>\nusing namespace std;\n\n// write add, subtract, multiply, divide here\n\nint main() {\n    int a, b;\n    char op;\n    cin >> a >> op >> b;\n\n    return 0;\n}',
        ...
        hints: [
          { en: 'double divide(int a, int b) { return (double)a / b; }', id: 'double bagi(int a, int b) { return (double)a / b; }' },
          { en: 'switch (op) { case \'+\': cout << add(a, b) << endl; break; ... }', id: 'switch (op) { case \'+\': cout << tambah(a, b) << endl; break; ... }' },
        ],
        solution: {
          en: '#include <iostream>\nusing namespace std;\n\nint add(int a, int b) { return a + b; }\nint subtract(int a, int b) { return a - b; }\nint multiply(int a, int b) { return a * b; }\ndouble divide(int a, int b) { return (double)a / b; }\n\nint main() {\n    int a, b;\n    char op;\n    cin >> a >> op >> b;\n    switch (op) {\n        case \'+\': cout << add(a, b) << endl; break;\n        case \'-\': cout << subtract(a, b) << endl; break;\n        case \'*\': cout << multiply(a, b) << endl; break;\n        case \'/\': cout << divide(a, b) << endl; break;\n        default: cout << "Unknown operator" << endl;\n    }\n    return 0;\n}',
    ...
    /* --------------------------------------------------------- 4.2 pointers */
    {
        ...
        },
        {
          ...
          steps: [
            ...
            },
            {
              kind: 'quiz',
              id: 'q1',
              prompt: { en: 'Why does failedSwap(x, y) leave x and y unchanged?', id: 'Mengapa gagalTukar(x, y) membiarkan x dan y tidak berubah?' },
              code: {
                en: 'void failedSwap(int a, int b) {\n    int temp = a; a = b; b = temp;\n}',
                id: 'void gagalTukar(int a, int b) {\n    int temp = a; a = b; b = temp;\n}',
              },
              options: [
            ...
            },
            {
              ...
              id: 'f1',
              prompt: {
                en: 'Call swap so it actually reaches x and y.',
            ...
            },
            {
              ...
              id: 'w1',
              prompt: {
                en: 'Write `void zeroOut(int *p)` that sets whatever p points at to 0. Apply it to a variable `x` starting at 99 and print x.',
              ...
              starter: {
                en: '#include <iostream>\nusing namespace std;\n\n// write the zeroOut function here\n\nint main() {\n    int x = 99;\n\n    return 0;\n}',
                id: '#include <iostream>\nusing namespace std;\n\n// tulis fungsi keNol di sini\n\nint main() {\n    int x = 99;\n\n    return 0;\n}',
              },
              tests: [{ name: { en: 'x becomes 0', id: 'x menjadi 0' }, expectOutput: '0' }],
              hints: [
                { en: 'void zeroOut(int *p) { *p = 0; }', id: 'void keNol(int *p) { *p = 0; }' },
                { en: 'zeroOut(&x); then print x.', id: 'keNol(&x); lalu cetak x.' },
              ],
              solution: {
                en: '#include <iostream>\nusing namespace std;\n\nvoid zeroOut(int *p) {\n    *p = 0;\n}\n\nint main() {\n    int x = 99;\n    zeroOut(&x);\n    cout << x << endl;\n    return 0;\n}',
                id: '#include <iostream>\nusing namespace std;\n\nvoid keNol(int *p) {\n    *p = 0;\n}\n\nint main() {\n    int x = 99;\n    keNol(&x);\n    cout << x << endl;\n    return 0;\n}',
        ...
        },
        {
          ...
          steps: [
            ...
            },
            {
              kind: 'quiz',
              id: 'q1',
              prompt: { en: 'p points at the start of values. What is p[2]?', id: 'p menunjuk ke awal nilai. Berapa p[2]?' },
              code: {
                en: 'int values[4] = {1, 3, 5, 7};\nint *p = values;',
                id: 'int nilai[4] = {1, 3, 5, 7};\nint *p = nilai;',
              },
              options: [
                { en: '5', id: '5' },
                { en: '2', id: '2' },
            ...
            },
            {
              ...
              id: 'f1',
              prompt: {
                en: 'Point p at the start of values.',
                id: 'Arahkan p ke awal nilai.',
              },
              template: {
                en: 'int values[5] = {1,2,3,4,5};\nint *p = ___;',
                id: 'int nilai[5] = {1,2,3,4,5};\nint *p = ___;',
              },
              blanks: {
                en: ['values'],
                id: ['nilai'],
            ...
            },
            {
              ...
              id: 'w1',
              prompt: {
                en: 'Declare `int values[4] = {3, 6, 9, 12};` and a pointer `p` at its start. Print `p[1] + p[3]`.',
              ...
              hints: [
                { en: 'int *p = values;', id: 'int *p = nilai;' },
      ...
      project: {
        ...
        requirements: [
          { en: 'Write `void swap(int *a, int *b)` that swaps what the two pointers point at.', id: 'Tulis `void tukar(int *a, int *b)` yang menukar apa yang ditunjuk kedua pointer.' },
          { en: 'Read three whole numbers a, b, c.', id: 'Baca tiga bilangan bulat a, b, c.' },
          { en: 'Sort them ascending using only calls to swap — no other reassignment.', id: 'Urutkan menaik hanya memakai pemanggilan tukar — tidak ada penetapan ulang lain.' },
          { en: 'Print `<smallest> <middle> <largest>` on one line.', id: 'Cetak `<terkecil> <tengah> <terbesar>` dalam satu baris.' },
        ],
        starter: {
          en: '#include <iostream>\nusing namespace std;\n\nvoid swap(int *a, int *b) {\n    int temp = *a;\n    *a = *b;\n    *b = temp;\n}\n\nint main() {\n    int a, b, c;\n    cin >> a >> b >> c;\n\n    return 0;\n}',
          id: '#include <iostream>\nusing namespace std;\n\nvoid tukar(int *a, int *b) {\n    int temp = *a;\n    *a = *b;\n    *b = temp;\n}\n\nint main() {\n    int a, b, c;\n    cin >> a >> b >> c;\n\n    return 0;\n}',
        ...
        hints: [
          { en: 'Three compares are enough: if (a>b) swap(&a,&b); if (b>c) swap(&b,&c); if (a>b) swap(&a,&b);', id: 'Tiga perbandingan sudah cukup: if (a>b) tukar(&a,&b); if (b>c) tukar(&b,&c); if (a>b) tukar(&a,&b);' },
