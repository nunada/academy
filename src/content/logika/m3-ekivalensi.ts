  ...
  submodules: [
    {
      ...
      lessons: [
        {
          ...
          steps: [
            ...
            },
            {
              ...
              lines: {
                en: [
                  '\\begin{array} p & q & p \\lor q & p \\Rightarrow (p \\lor q)',
                  'B & B & B & B',
                  'B & S & B & B',
                  'S & B & B & B',
                  'S & S & S & B',
      ...
      project: {
        ...
        requirements: [
          ...
          { en: 'Answer 1 for tautology / equivalent / true, 0 otherwise.', id: 'Jawab 1 untuk tautologi / ekivalen / benar, 0 untuk sebaliknya.' },
        ],
        tasks: [
          {
            prompt: {
              en: 'Is $(p \\land q) \\Rightarrow p$ a tautology?',
              id: 'Apakah $(p \\land q) \\Rightarrow p$ tautologi?',
            },
            blanks: [{ answer: 1 }],
            solution: ['Jika $p \\land q$ benar, $p$ pasti ikut benar; jika $p \\land q$ salah, kondisionalnya benar secara hampa. Setiap baris benar — tautologi.'],
          },
          {
            prompt: {
              en: 'Is $(p \\Rightarrow q) \\land (p \\Rightarrow \\neg q)$ a contradiction for a $p$ that is true? Check by evaluating it for $p$ true, $q$ true.',
              id: 'Apakah $(p \\Rightarrow q) \\land (p \\Rightarrow \\neg q)$ kontradiksi untuk $p$ yang benar? Periksa dengan menentukan nilainya untuk $p$ benar, $q$ benar.',
            },
            blanks: [{ label: '(p \\Rightarrow q) \\land (p \\Rightarrow \\neg q) =', answer: 0 }],
            solution: ['Dengan $p$ benar, $q$ benar: $p \\Rightarrow q$ benar tetapi $p \\Rightarrow \\neg q$ salah, jadi konjungsinya salah untuk baris ini.'],
          },
          {
            prompt: {
              en: 'Are $p \\Leftrightarrow q$ and $(p \\land q) \\lor (\\neg p \\land \\neg q)$ logically equivalent? Check by evaluating both for $p$ false, $q$ false.',
              id: 'Apakah $p \\Leftrightarrow q$ dan $(p \\land q) \\lor (\\neg p \\land \\neg q)$ ekivalen secara logis? Periksa dengan menentukan nilai keduanya untuk $p$ salah, $q$ salah.',
            },
            blanks: [
              { label: 'p \\Leftrightarrow q =', answer: 1 },
              { label: '(p \\land q) \\lor (\\neg p \\land \\neg q) =', answer: 1 },
            ],
            solution: ['Untuk $p$ salah, $q$ salah: keduanya sepakat, jadi $p \\Leftrightarrow q$ benar. Dan $\\neg p \\land \\neg q$ benar (keduanya benar), jadi disjungsinya juga benar — keduanya cocok di baris ini, sebagaimana pada setiap baris lainnya.'],
          },
        ],
        hints: [
          {
            en: 'Work through each expression one connective at a time, innermost first, for the specific truth values given.',
            id: 'Kerjakan tiap ungkapan satu penghubung setiap kali, yang paling dalam lebih dulu, untuk nilai kebenaran tertentu yang diberikan.',
          },
        ],
        xp: 50,
      },
