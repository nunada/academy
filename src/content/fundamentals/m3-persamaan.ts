        ...
        },
        {
          ...
          steps: [
            ...
            },
            {
              ...
              body: {
                en: 'The quantity under the root, $D = b^2-4ac$, is the **discriminant**, and its sign alone tells you how many real solutions exist, no need to finish solving:\n\n- $D>0$ gives two distinct real solutions.\n- $D=0$ gives exactly one real solution (a repeated root).\n- $D<0$ gives no real solution at all, since the root of a negative number is not real.\n\nDrag the slider below: the parabola is $y=x^2-4x+c$, whose roots are exactly the solutions of $x^2-4x+c=0$. Watch the two roots merge into one as $c$ reaches $4$ (where $D=16-4c=0$), then vanish entirely once $c>4$ and $D<0$.',
                id: 'Kuantitas di bawah akar, $D = b^2-4ac$, adalah **diskriminan**, dan tandanya saja memberitahu berapa banyak solusi real yang ada, tanpa perlu menuntaskan penyelesaiannya:\n\n- $D>0$ memberi dua solusi real berbeda.\n- $D=0$ memberi tepat satu solusi real (akar berulang).\n- $D<0$ memberi tak ada solusi real sama sekali, sebab akar dari bilangan negatif bukan bilangan real.\n\nGeser penggeser di bawah: parabolanya adalah $y=x^2-4x+c$, yang akarnya persis solusi dari $x^2-4x+c=0$. Amati kedua akar menyatu menjadi satu ketika $c$ mencapai $4$ (saat $D=16-4c=0$), lalu lenyap sepenuhnya begitu $c>4$ dan $D<0$.',
              },
              figure: {
                dim: 2,
                xSpan: [-2, 7],
          ...
          steps: [
            {
              ...
              body: {
                en: 'Turning words into an equation always follows the same four steps:\n\n- **Identify the variable** (the quantity the question actually asks for).\n- **Translate to algebra** (express every quantity mentioned in terms of that variable).\n- **Set up the model** (find the sentence in the problem that becomes the equation).\n- **Solve, and check** that the answer makes sense in the real-world context.\n\nA car rental costs ﹩30/day plus 15¢/mile; a 2-day rental bills ﹩108. Let $x$ = miles driven. Mileage cost is $0.15x$, daily cost is $2(30)=60$. The model: $0.15x+60=108$, so $x=320$ miles.',
                id: 'Mengubah kata-kata menjadi persamaan selalu mengikuti empat langkah yang sama:\n\n- **Identifikasi variabelnya** (kuantitas yang sungguh ditanyakan soalnya).\n- **Terjemahkan ke aljabar** (nyatakan setiap kuantitas yang disebut dalam bentuk variabel itu).\n- **Susun modelnya** (temukan kalimat dalam soal yang menjadi persamaannya).\n- **Selesaikan, dan periksa** apakah jawabannya masuk akal dalam konteks dunia nyata.\n\nSewa mobil berharga Rp300.000/hari plus Rp1.500/km; sewa 2 hari menagih Rp1.080.000. Misalkan $x$ = km yang ditempuh. Biaya jarak adalah $1500x$, biaya harian adalah $2(300{.}000)=600{.}000$. Modelnya: $1500x+600{.}000=1{.}080{.}000$, sehingga $x=320$ km.',
              },
            },
            {
              kind: 'concept',
