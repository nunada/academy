        ...
        },
        {
          ...
          steps: [
            ...
            },
            {
              ...
              body: {
                en: 'Test symmetry algebraically, by substituting and checking if the equation is unchanged:\n\n- For the $x$-**axis**, replace $y$ with $-y$ — unchanged means the graph flips onto itself top-to-bottom.\n- For the $y$-**axis**, replace $x$ with $-x$ — unchanged means left-right symmetry.\n- For the **origin**, replace both — unchanged means $180°$ rotational symmetry.\n\nFor $y=x^2$: replacing $x$ with $-x$ gives $y=(-x)^2=x^2$, unchanged — symmetric about the $y$-axis. For $x=y^2$: replacing $y$ with $-y$ gives $x=(-y)^2=y^2$, unchanged — symmetric about the $x$-axis instead.',
                id: 'Uji simetri secara aljabar, dengan mensubstitusi dan memeriksa apakah persamaannya tak berubah:\n\n- Untuk sumbu-$x$, ganti $y$ dengan $-y$ — tak berubah berarti grafiknya membalik ke dirinya sendiri atas-bawah.\n- Untuk sumbu-$y$, ganti $x$ dengan $-x$ — tak berubah berarti simetri kiri-kanan.\n- Untuk **titik asal**, ganti keduanya — tak berubah berarti simetri rotasi $180°$.\n\nUntuk $y=x^2$: mengganti $x$ dengan $-x$ memberi $y=(-x)^2=x^2$, tak berubah — simetris terhadap sumbu-$y$. Untuk $x=y^2$: mengganti $y$ dengan $-y$ memberi $x=(-y)^2=y^2$, tak berubah — simetris terhadap sumbu-$x$ sebagai gantinya.',
              },
              figure: {
                dim: 2,
                xSpan: [-4, 4],
          ...
          steps: [
            {
              ...
              body: {
                en: 'The **slope** of the line through $(x_1,y_1)$ and $(x_2,y_2)$ is the ratio of rise to run:\n$$m = \\frac{y_2-y_1}{x_2-x_1}$$\n\n\n- Positive slope climbs left to right.\n- Negative slope falls.\n- A horizontal line has slope $0$.\n- A vertical line has **no** slope (the run is $0$, and division by $0$ is undefined).\n\nThrough $(2,1)$ and $(8,5)$: $m=\\dfrac{5-1}{8-2}=\\dfrac{4}{6}=\\dfrac{2}{3}$ — for every $3$ units right, the line rises $2$.',
                id: '**Kemiringan** garis melalui $(x_1,y_1)$ dan $(x_2,y_2)$ adalah rasio naik terhadap datar:\n$$m = \\frac{y_2-y_1}{x_2-x_1}$$\n\n\n- Kemiringan positif menanjak dari kiri ke kanan.\n- Kemiringan negatif menurun.\n- Garis mendatar berkemiringan $0$.\n- Garis tegak **tak punya** kemiringan (datarnya $0$, dan pembagian dengan $0$ tak terdefinisi).\n\nMelalui $(2,1)$ dan $(8,5)$: $m=\\dfrac{5-1}{8-2}=\\dfrac{4}{6}=\\dfrac{2}{3}$ — untuk setiap $3$ satuan ke kanan, garisnya naik $2$.',
              },
              figure: {
                dim: 2,
                xSpan: [0, 10],
