          ...
          steps: [
            {
              ...
              body: {
                en: 'Each number system builds on the one before it:\n\n| Set | Adds | Examples |\n|---|---|---|\n| **Natural** numbers | the counting numbers | $1, 2, 3, \\ldots$ |\n| **Integers** | their negatives and $0$ | $\\ldots, -2, -1, 0, 1, 2, \\ldots$ |\n| **Rational** numbers | any ratio $\\frac{m}{n}$ of integers, $n \\neq 0$ | $\\frac{1}{2}$, $46$ (as $\\frac{46}{1}$), $0.17$ (as $\\frac{17}{100}$) |\n| **Irrational** numbers | reals that are not a ratio of integers | $\\sqrt{2}$, $\\pi$, $\\sqrt[3]{5}$ |\n\n- Every real number is either rational or irrational, never both.\n- Division by $0$ is always undefined: $\\frac{3}{0}$ and $\\frac{0}{0}$ are simply not numbers.',
                id: 'Setiap sistem bilangan dibangun di atas yang sebelumnya:\n\n| Himpunan | Menambahkan | Contoh |\n|---|---|---|\n| Bilangan **asli** | bilangan pencacah | $1, 2, 3, \\ldots$ |\n| Bilangan **bulat** | negatifnya dan $0$ | $\\ldots, -2, -1, 0, 1, 2, \\ldots$ |\n| Bilangan **rasional** | rasio $\\frac{m}{n}$ bilangan bulat mana pun, $n \\neq 0$ | $\\frac{1}{2}$, $46$ (sebagai $\\frac{46}{1}$), $0.17$ (sebagai $\\frac{17}{100}$) |\n| Bilangan **irasional** | bilangan real yang bukan rasio bilangan bulat | $\\sqrt{2}$, $\\pi$, $\\sqrt[3]{5}$ |\n\n- Setiap bilangan real pasti rasional atau irasional, tak pernah keduanya.\n- Pembagian dengan $0$ selalu tak terdefinisi: $\\frac{3}{0}$ dan $\\frac{0}{0}$ sederhananya bukan bilangan.',
              },
              figure: {
                dim: 2,
                range: 5,
            ...
            },
            {
              ...
              body: {
                en: 'Every real number has a decimal expansion, and the pattern of that expansion reveals which kind it is:\n\n- A **rational** number\'s decimal always **repeats** (or terminates, which is repeating $0$s): $\\frac{1}{2} = 0.5\\overline{0}$, $\\frac{2}{3} = 0.\\overline{6}$, $\\frac{9}{7} = 1.\\overline{285714}$.\n- An **irrational** number\'s decimal **never repeats**: $\\sqrt{2} = 1.414213562\\ldots$, $\\pi = 3.141592653\\ldots$\n\nOn the **real line**, positive numbers sit to the right of the origin $0$ and negative numbers to the left, each at a distance equal to its value. We say $a < b$ ("$a$ is less than $b$") exactly when $b - a$ is positive — equivalently, when $a$ sits to the left of $b$.',
                id: 'Setiap bilangan real punya ekspansi desimal, dan pola ekspansinya mengungkap jenisnya:\n\n- Desimal bilangan **rasional** selalu **berulang** (atau berhenti, yang sama dengan berulang $0$): $\\frac{1}{2} = 0.5\\overline{0}$, $\\frac{2}{3} = 0.\\overline{6}$, $\\frac{9}{7} = 1.\\overline{285714}$.\n- Desimal bilangan **irasional** **tak pernah berulang**: $\\sqrt{2} = 1.414213562\\ldots$, $\\pi = 3.141592653\\ldots$\n\nPada **garis bilangan**, bilangan positif duduk di kanan titik asal $0$ dan bilangan negatif di kiri, masing-masing sejauh nilainya. Kita tulis $a < b$ ("$a$ kurang dari $b$") persis ketika $b - a$ positif — setara dengan, ketika $a$ duduk di kiri $b$.',
              },
              figure: {
                dim: 2,
                xSpan: [-3, 4],
