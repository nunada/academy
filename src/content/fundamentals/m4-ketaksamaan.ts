  ...
  submodules: [
    {
          ...
          steps: [
            {
              ...
              body: {
                en: 'A quadratic (or other nonlinear) inequality can\'t be isolated the way a linear one can. Instead:\n\n- Move every term to one side, leaving $0$ on the other.\n- **Factor** the nonzero side.\n- Find the numbers where each factor is zero, which split the real line into **intervals**.\n- Pick a **test value** in each interval to find the sign of each factor there, and hence the sign of the whole product.\n- Read off the intervals where the inequality holds, checking whether the endpoints themselves qualify.\n\nFor $x^2 < 5x+6$: rewrite as $x^2-5x-6<0$, factor as $(x-6)(x+1)<0$. The factors are zero at $x=-1$ and $x=6$.',
                id: 'Pertidaksamaan kuadrat (atau nonlinear lain) tak bisa diisolasi seperti pertidaksamaan linear. Sebagai gantinya:\n\n- Pindahkan setiap suku ke satu ruas, menyisakan $0$ di ruas lain.\n- **Faktorkan** ruas taknolnya.\n- Cari bilangan di mana tiap faktor bernilai nol, yang membagi garis bilangan menjadi **interval**.\n- Pilih **nilai uji** pada tiap interval untuk mencari tanda tiap faktor di situ, dan karenanya tanda keseluruhan hasil kalinya.\n- Baca interval di mana pertidaksamaannya berlaku, periksa apakah titik ujungnya sendiri memenuhi.\n\nUntuk $x^2 < 5x+6$: tulis ulang sebagai $x^2-5x-6<0$, faktorkan sebagai $(x-6)(x+1)<0$. Faktor-faktornya nol di $x=-1$ dan $x=6$.',
              },
              figure: {
                dim: 2,
                xSpan: [-4, 9],
          ...
          steps: [
            ...
            },
            {
              ...
              prompt: {
                ...
                id: 'Perusahaan C membebankan Rp250.000/hari + Rp3.000/km; Perusahaan D membebankan Rp550.000/hari + Rp1.800/km. Untuk sewa satu hari, lewat berapa km D lebih murah?',
              },
              blanks: [{ answer: 250 }],
              hints: [
              ...
              explain: {
                ...
                id: '$300{.}000<1200x \\Rightarrow x>250$ km.',
              },
            },
          ],
        },
      ...
      project: {
        ...
        tasks: [
          ...
          {
            prompt: { en: 'Company E: ﹩15/day + ﹩0.45/mile. Company F: ﹩45/day + ﹩0.20/mile. Beyond how many miles is F cheaper for a one-day rental?', id: 'Perusahaan E: Rp150.000/hari + Rp4.500/km. Perusahaan F: Rp450.000/hari + Rp2.000/km. Lewat berapa km F lebih murah untuk sewa satu hari?' },
            blanks: [{ answer: 120 }],
            solution: {
